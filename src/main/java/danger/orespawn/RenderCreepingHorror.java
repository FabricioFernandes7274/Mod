...
extends RenderLiving {
    protected ModelCreepingHorror model = (ModelCreepingHorror)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "CreepingHorror.png");

    public RenderCreepingHorror(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelCreepingHorror par1ModelBase, float par2, float par3) {
