...
extends RenderLiving {
    protected ModelBeaver model = (ModelBeaver)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "Beavertexture.png");

    public RenderBeaver(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelBeaver par1ModelBase, float par2, float par3) {
