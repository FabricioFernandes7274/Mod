...
extends RenderLiving {
    protected ModelChipmunk model = (ModelChipmunk)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "chipmunktexture.png");
