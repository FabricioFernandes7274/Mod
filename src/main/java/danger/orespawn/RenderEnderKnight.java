...
extends RenderLiving {
    protected ModelEnderKnight model = (ModelEnderKnight)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "EnderKnighttexture.png");

    public RenderEnderKnight(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelEnderKnight par1ModelBase, float par2, float par3) {
