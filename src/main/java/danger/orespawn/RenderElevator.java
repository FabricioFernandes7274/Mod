...
extends Render {
    ...
    public RenderElevator(RenderManager renderManager) {
        super(renderManager);
    ...
    public void renderElevator(Elevator par1EntityElevator, double par2, double par4, double par6, float par8, float par9) {
        ...
        if (f2 > 0.0f) {
            GL11.glRotatef((float)(net.minecraft.util.math.MathHelper.sin((float)f2) * f2 * f3 / 10.0f * (float)par1EntityElevator.getForwardDirection()), (float)1.0f, (float)0.0f, (float)0.0f);
        }
        float f4 = 0.75f;
