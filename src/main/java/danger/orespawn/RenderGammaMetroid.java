...
extends RenderLiving {
    protected ModelGammaMetroid model = (ModelGammaMetroid)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "GammaMetroid.png");

    public RenderGammaMetroid(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelGammaMetroid par1ModelBase, float par2, float par3) {
