...
extends RenderLiving {
    protected ModelPointysaurus model = (ModelPointysaurus)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "Pointysaurustexture.png");

    public RenderPointysaurus(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelPointysaurus par1ModelBase, float par2, float par3) {
