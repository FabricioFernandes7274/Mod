...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        newangle = (double)f1 > 0.1 || c.getAttacking() != 0 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 2.3f * this.wingspeed)) * (float)Math.PI * 0.4f * f1 : net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.3f * this.wingspeed)) * (float)Math.PI * 0.04f;
        ...
        newangle = (double)f1 > 0.1 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 2.0f * this.wingspeed)) * (float)Math.PI * 0.25f * f1 : 0.0f;
        ...
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.9f * this.wingspeed)) * (float)Math.PI * 0.06f;
        if (c.isSitting()) {
            newangle = 0.0f;
        }
        if (c.getAttacking() != 0) {
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed)) * (float)Math.PI * 0.12f;
        }
        ...
        float Ljx = 0.0f;
        if (c.getAttacking() != 0) {
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.9f * this.wingspeed)) * (float)Math.PI * 0.2f;
            Ljx = 0.2f + newangle;
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 2.1f * this.wingspeed)) * (float)Math.PI * 0.2f;
            Rjx = 0.2f + newangle;
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 2.3f * this.wingspeed)) * (float)Math.PI * 0.2f;
            jx = 0.2f + newangle;
        }
        ...
        if ((double)this.Lpower.rotateAngleX > Math.PI) {
            this.Lpower.rotateAngleX = (float)((double)this.Lpower.rotateAngleX - Math.PI * 2);
        }
        this.Cpower.rotateAngleX += 0.04f;
        if ((double)this.Cpower.rotateAngleX > Math.PI) {
            this.Cpower.rotateAngleX = (float)((double)this.Cpower.rotateAngleX - Math.PI * 2);
        }
        this.Rpower.rotateAngleX += 0.05f;
        if ((double)this.Rpower.rotateAngleX > Math.PI) {
            this.Rpower.rotateAngleX = (float)((double)this.Rpower.rotateAngleX - Math.PI * 2);
        }
        this.Lpower.rotateAngleY += 0.035f;
        if ((double)this.Lpower.rotateAngleY > Math.PI) {
            this.Lpower.rotateAngleY = (float)((double)this.Lpower.rotateAngleY - Math.PI * 2);
        }
        this.Cpower.rotateAngleY += 0.046f;
        if ((double)this.Cpower.rotateAngleY > Math.PI) {
            this.Cpower.rotateAngleY = (float)((double)this.Cpower.rotateAngleY - Math.PI * 2);
        }
        this.Rpower.rotateAngleY += 0.065f;
        if ((double)this.Rpower.rotateAngleY > Math.PI) {
            this.Rpower.rotateAngleY = (float)((double)this.Rpower.rotateAngleY - Math.PI * 2);
        }
        this.Lpower.rotateAngleZ += 0.05f;
        if ((double)this.Lpower.rotateAngleZ > Math.PI) {
            this.Lpower.rotateAngleZ = (float)((double)this.Lpower.rotateAngleZ - Math.PI * 2);
        }
        this.Cpower.rotateAngleZ += 0.13f;
        if ((double)this.Cpower.rotateAngleZ > Math.PI) {
            this.Cpower.rotateAngleZ = (float)((double)this.Cpower.rotateAngleZ - Math.PI * 2);
        }
        this.Rpower.rotateAngleZ += 0.03f;
        if ((double)this.Rpower.rotateAngleZ > Math.PI) {
            this.Rpower.rotateAngleZ = (float)((double)this.Rpower.rotateAngleZ - Math.PI * 2);
        }
        this.body.render(f5);
