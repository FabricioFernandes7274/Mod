...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        if ((double)f1 > 0.001) {
            ...
            newangle2 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.75f * this.wingspeed / pscale + pi4));
        ...
        this.LLowerLeg.rotateAngleX = 0.22f + newangle * (float)Math.PI * 0.09f * f1;
        this.LUpperLeg.rotateAngleX = -0.17f + newangle2 * (float)Math.PI * 0.15f * f1;
        ...
        this.LThigh.rotateAngleX = -0.558f + newangle2 * (float)Math.PI * 0.1f * f1;
        ...
        if ((double)f1 > 0.001) {
            ...
            newangle2 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.75f * this.wingspeed / pscale + pi4 * 5.0f));
        ...
        this.RLegLower.rotateAngleX = 0.22f + newangle * (float)Math.PI * 0.09f * f1;
        this.RLegUpper.rotateAngleX = -0.17f + newangle2 * (float)Math.PI * 0.15f * f1;
        ...
        this.RThigh.rotateAngleX = -0.558f + newangle2 * (float)Math.PI * 0.1f * f1;
        ...
        newangle = e.getAttacking() != 0 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * this.wingspeed * 1.75f)) * (float)Math.PI * 0.2f : net.minecraft.util.math.MathHelper.cos((float)(f2 * this.wingspeed * 0.75f)) * (float)Math.PI * 0.05f;
        ...
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * this.wingspeed * 1.5f)) * (float)Math.PI * 0.12f;
        ...
        newangle = newangle2 = net.minecraft.util.math.MathHelper.sin((float)(f2 * this.wingspeed * 1.75f)) * (float)Math.PI * 0.16f;
