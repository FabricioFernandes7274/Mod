...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 4.0f * this.wingspeed)) * (float)Math.PI * 0.5f * f1;
        ...
        if (e.getAttacking() == 0) {
            ...
            float fanamp = 0.1f;
            this.fan.rotateAngleX = net.minecraft.util.math.MathHelper.cos((float)(f2 * fanspeed * this.wingspeed)) * (float)Math.PI * fanamp;
            this.fanl1.rotateAngleX = net.minecraft.util.math.MathHelper.cos((float)(f2 * fanspeed * this.wingspeed - 1.0f * pi6)) * (float)Math.PI * fanamp;
            this.fanl2.rotateAngleX = net.minecraft.util.math.MathHelper.cos((float)(f2 * fanspeed * this.wingspeed - 2.0f * pi6)) * (float)Math.PI * fanamp;
            this.fanl3.rotateAngleX = net.minecraft.util.math.MathHelper.cos((float)(f2 * fanspeed * this.wingspeed - 3.0f * pi6)) * (float)Math.PI * fanamp;
            this.fanl4.rotateAngleX = net.minecraft.util.math.MathHelper.cos((float)(f2 * fanspeed * this.wingspeed - 4.0f * pi6)) * (float)Math.PI * fanamp;
            this.fanl5.rotateAngleX = net.minecraft.util.math.MathHelper.cos((float)(f2 * fanspeed * this.wingspeed - 5.0f * pi6)) * (float)Math.PI * fanamp;
            this.fanl6.rotateAngleX = net.minecraft.util.math.MathHelper.cos((float)(f2 * fanspeed * this.wingspeed - 6.0f * pi6)) * (float)Math.PI * fanamp;
            this.fanl7.rotateAngleX = net.minecraft.util.math.MathHelper.cos((float)(f2 * fanspeed * this.wingspeed - 7.0f * pi6)) * (float)Math.PI * fanamp;
            this.fanr1.rotateAngleX = net.minecraft.util.math.MathHelper.cos((float)(f2 * fanspeed * this.wingspeed - 1.0f * pi6)) * (float)Math.PI * fanamp;
            this.fanr2.rotateAngleX = net.minecraft.util.math.MathHelper.cos((float)(f2 * fanspeed * this.wingspeed - 2.0f * pi6)) * (float)Math.PI * fanamp;
            this.fanr3.rotateAngleX = net.minecraft.util.math.MathHelper.cos((float)(f2 * fanspeed * this.wingspeed - 3.0f * pi6)) * (float)Math.PI * fanamp;
            this.fanr4.rotateAngleX = net.minecraft.util.math.MathHelper.cos((float)(f2 * fanspeed * this.wingspeed - 4.0f * pi6)) * (float)Math.PI * fanamp;
            this.fanr5.rotateAngleX = net.minecraft.util.math.MathHelper.cos((float)(f2 * fanspeed * this.wingspeed - 5.0f * pi6)) * (float)Math.PI * fanamp;
            this.fanr6.rotateAngleX = net.minecraft.util.math.MathHelper.cos((float)(f2 * fanspeed * this.wingspeed - 6.0f * pi6)) * (float)Math.PI * fanamp;
            this.fanr7.rotateAngleX = net.minecraft.util.math.MathHelper.cos((float)(f2 * fanspeed * this.wingspeed - 7.0f * pi6)) * (float)Math.PI * fanamp;
            this.fan.rotateAngleZ = 0.0f;
        ...
        r = e.getRenderInfo();
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 3.5f * this.wingspeed)) * (float)Math.PI * 0.5f;
        nextangle = net.minecraft.util.math.MathHelper.cos((float)((f2 + 0.2f) * 3.5f * this.wingspeed)) * (float)Math.PI * 0.5f;
        if (nextangle > 0.0f && newangle < 0.0f) {
            if (e.getAttacking() == 0) {
                r.ri1 = e.world.rand.nextInt(15);
                r.ri2 = e.world.rand.nextInt(15);
                r.ri3 = e.world.rand.nextInt(15);
            } else {
                r.ri1 = e.world.rand.nextInt(4);
                r.ri2 = e.world.rand.nextInt(2);
                r.ri3 = 1;
            }
        }
        if (r.ri2 == 1) {
            ...
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * this.wingspeed)) * (float)Math.PI * 0.05f;
            this.doTail(newangle);
        }
        if (r.ri3 == 1) {
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 3.5f * this.wingspeed)) * (float)Math.PI * 0.35f;
            this.doJaw(newangle);
        } else {
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * this.wingspeed)) * (float)Math.PI * 0.02f;
            this.doJaw(newangle);
        }
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * this.wingspeed * 3.5f)) * (float)Math.PI * 0.2f;
        if (r.ri1 == 1 || r.ri1 == 3) {
            this.doLeftClaw(newangle);
        } else {
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * this.wingspeed)) * (float)Math.PI * 0.03f;
            this.doLeftClaw(newangle);
        }
        if (r.ri1 == 2 || r.ri1 == 3) {
