...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        this.leg2.rotateAngleY = this.leg3.rotateAngleY = (float)(-1.5707963267948966 + (double)(net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.7f)) * (float)Math.PI * 0.15f * f1));
        ...
        this.leg3.render(f5);
        if (e.getAttacking() == 0) {
            this.Leye1.rotateAngleX = this.Leye2.rotateAngleX = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.35f)) * (float)Math.PI * 0.05f;
            this.Leye1.rotateAngleZ = this.Leye2.rotateAngleZ = 0.54f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.25f)) * (float)Math.PI * 0.05f;
            this.Reye1.rotateAngleX = this.Reye2.rotateAngleX = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.3f)) * (float)Math.PI * 0.05f;
            this.Reye1.rotateAngleZ = this.Reye2.rotateAngleZ = -0.54f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.45f)) * (float)Math.PI * 0.05f;
            this.Lmouth.rotateAngleY = -0.72f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.25f)) * (float)Math.PI * 0.05f;
            this.Rmouth.rotateAngleY = 0.72f - net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.25f)) * (float)Math.PI * 0.05f;
            float newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.15f)) * (float)Math.PI * 0.03f;
            this.Lclaw3.rotateAngleY = -0.453f + newangle;
            this.Lclaw4.rotateAngleY = -0.349f + newangle;
            this.Lclaw5.rotateAngleY = 0.384f - newangle;
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.13f)) * (float)Math.PI * 0.02f;
            this.Rclaw3.rotateAngleY = 0.453f + newangle;
            this.Rclaw4.rotateAngleY = 0.349f + newangle;
            this.Rclaw5.rotateAngleY = -0.384f - newangle;
        } else {
            this.Leye1.rotateAngleX = this.Leye2.rotateAngleX = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.45f)) * (float)Math.PI * 0.1f;
            this.Leye1.rotateAngleZ = this.Leye2.rotateAngleZ = 0.54f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.35f)) * (float)Math.PI * 0.1f;
            this.Reye1.rotateAngleX = this.Reye2.rotateAngleX = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.4f)) * (float)Math.PI * 0.1f;
            this.Reye1.rotateAngleZ = this.Reye2.rotateAngleZ = -0.54f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.55f)) * (float)Math.PI * 0.1f;
            this.Lmouth.rotateAngleY = -0.72f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.45f)) * (float)Math.PI * 0.15f;
            this.Rmouth.rotateAngleY = 0.72f - net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.45f)) * (float)Math.PI * 0.15f;
            float newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.35f)) * (float)Math.PI * 0.13f;
            this.Lclaw3.rotateAngleY = -0.453f + newangle;
            this.Lclaw4.rotateAngleY = -0.349f + newangle;
            this.Lclaw5.rotateAngleY = 0.384f - newangle;
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.43f)) * (float)Math.PI * 0.12f;
            this.Rclaw3.rotateAngleY = 0.453f + newangle;
            this.Rclaw4.rotateAngleY = 0.349f + newangle;
            this.Rclaw5.rotateAngleY = -0.384f - newangle;
        }
