...
extends RenderLiving {
    protected ModelCaveFisher model = (ModelCaveFisher)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "CaveFisher.png");

    public RenderCaveFisher(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelCaveFisher par1ModelBase, float par2, float par3) {
