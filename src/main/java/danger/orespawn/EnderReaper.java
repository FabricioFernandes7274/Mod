...
extends EntityMob {
    ...
    protected Entity findPlayerToAttack() {
        ...
        net.minecraft.entity.player.EntityPlayer entityplayer = this.world.getClosestVulnerablePlayerToEntity((Entity)this, 81.0);
    ...
    public boolean getCanSpawnHere() {
        ...
        target = (EnderReaper)this.world.findNearestEntityWithinAABB(EnderReaper.class, this.boundingBox.expand(16.0, 8.0, 16.0), (Entity)this);
        return target == null;
    }
