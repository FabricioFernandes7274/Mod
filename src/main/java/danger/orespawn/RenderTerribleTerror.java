...
extends RenderLiving {
    protected ModelTerribleTerror model = (ModelTerribleTerror)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "TerribleTerror.png");

    public RenderTerribleTerror(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelTerribleTerror par1ModelBase, float par2, float par3) {
