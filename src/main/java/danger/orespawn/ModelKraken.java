...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        this.Finright.rotateAngleZ = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.43f * this.wingspeed)) * (float)Math.PI * 0.15f;
        this.Finleft.rotateAngleZ = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.32f * this.wingspeed)) * (float)Math.PI * 0.14f;
        ...
        r = e.getRenderInfo();
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.66f)) * (float)Math.PI * 0.15f;
        nextangle = net.minecraft.util.math.MathHelper.cos((float)((f2 + 0.1f) * 0.66f)) * (float)Math.PI * 0.15f;
        if (nextangle > 0.0f && newangle < 0.0f) {
            r.ri1 = 0;
            if (e.getAttacking() == 0) {
                r.ri1 = e.world.rand.nextInt(10);
        ...
        newangle = r.ri1 == 1 || r.ri1 == 3 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed)) * (float)Math.PI * 0.015f : 0.0f;
    ...
    private void dangle_tentacle(float f2, int dir, int att, ModelRenderer p1, ModelRenderer p2, ModelRenderer p3, ModelRenderer p4, ModelRenderer p5, ModelRenderer p6, ModelRenderer p7, ModelRenderer p8) {
        ...
        p1.rotateAngleX = xoff + s * net.minecraft.util.math.MathHelper.cos((float)(f2 * differ * this.wingspeed)) * (float)Math.PI * amp;
        p1.rotateAngleY = yoff - net.minecraft.util.math.MathHelper.cos((float)(f2 * ydiffer * this.wingspeed)) * (float)Math.PI * amp;
        ...
        p2.rotateAngleX = xoff / 2.0f + s * net.minecraft.util.math.MathHelper.cos((float)(f2 * differ * this.wingspeed - pi4)) * (float)Math.PI * amp;
        p2.rotateAngleY = yoff / 2.0f - net.minecraft.util.math.MathHelper.cos((float)(f2 * ydiffer * this.wingspeed - pi4)) * (float)Math.PI * amp;
        ...
        p3.rotateAngleX = s * net.minecraft.util.math.MathHelper.cos((float)(f2 * differ * this.wingspeed - 2.0f * pi4)) * (float)Math.PI * amp;
        p3.rotateAngleY = -net.minecraft.util.math.MathHelper.cos((float)(f2 * ydiffer * this.wingspeed - 2.0f * pi4)) * (float)Math.PI * amp;
        ...
        p4.rotateAngleX = s * net.minecraft.util.math.MathHelper.cos((float)(f2 * differ * this.wingspeed - 3.0f * pi4)) * (float)Math.PI * amp;
        p4.rotateAngleY = -net.minecraft.util.math.MathHelper.cos((float)(f2 * ydiffer * this.wingspeed - 3.0f * pi4)) * (float)Math.PI * amp;
        ...
        p5.rotateAngleX = s * net.minecraft.util.math.MathHelper.cos((float)(f2 * differ * this.wingspeed - 4.0f * pi4)) * (float)Math.PI * amp;
        p5.rotateAngleY = -net.minecraft.util.math.MathHelper.cos((float)(f2 * ydiffer * this.wingspeed - 4.0f * pi4)) * (float)Math.PI * amp;
        ...
        p6.rotateAngleX = s * net.minecraft.util.math.MathHelper.cos((float)(f2 * differ * this.wingspeed - 5.0f * pi4)) * (float)Math.PI * amp;
        p6.rotateAngleY = -net.minecraft.util.math.MathHelper.cos((float)(f2 * ydiffer * this.wingspeed - 5.0f * pi4)) * (float)Math.PI * amp;
        ...
        p7.rotateAngleX = s * net.minecraft.util.math.MathHelper.cos((float)(f2 * differ * this.wingspeed - 6.0f * pi4)) * (float)Math.PI * amp;
        p7.rotateAngleY = -net.minecraft.util.math.MathHelper.cos((float)(f2 * ydiffer * this.wingspeed - 6.0f * pi4)) * (float)Math.PI * amp;
        ...
        p8.rotateAngleX = s * net.minecraft.util.math.MathHelper.cos((float)(f2 * differ * this.wingspeed - 7.0f * pi4)) * (float)Math.PI * amp;
        p8.rotateAngleY = -net.minecraft.util.math.MathHelper.cos((float)(f2 * ydiffer * this.wingspeed - 7.0f * pi4)) * (float)Math.PI * amp;
    }
}
