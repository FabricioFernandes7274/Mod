...
extends RenderLiving {
    protected ModelTheKing model = (ModelTheKing)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "TheKingtexture.png");

    public RenderTheKing(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelTheKing par1ModelBase, float par2, float par3) {
