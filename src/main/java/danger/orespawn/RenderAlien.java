...
extends RenderLiving {
    protected ModelAlien model = (ModelAlien)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "MyAlien.png");

    public RenderAlien(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelAlien par1ModelBase, float par2, float par3) {
