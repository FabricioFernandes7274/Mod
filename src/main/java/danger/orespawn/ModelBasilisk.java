...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        float newangle = 0.0f;
        newangle = (double)f1 > 0.1 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed)) * (float)Math.PI * 0.1f * f1 : 0.0f;
        float pi4 = 0.7853975f;
        this.body1.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed)) * (float)Math.PI * 0.1f * f1;
        ...
        this.body2.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed - pi4)) * (float)Math.PI * 0.1f * f1;
        ...
        this.body3.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed - 2.0f * pi4)) * (float)Math.PI * 0.1f * f1;
        ...
        this.body4.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed - 3.0f * pi4)) * (float)Math.PI * 0.1f * f1;
        ...
        this.body5.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed - 4.0f * pi4)) * (float)Math.PI * 0.1f * f1;
        ...
        this.body6.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed - 5.0f * pi4)) * (float)Math.PI * 0.1f * f1;
        ...
        this.tail1.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed - 6.0f * pi4)) * (float)Math.PI * 0.1f * f1;
        ...
        this.tail2.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed - 7.0f * pi4)) * (float)Math.PI * 0.1f * f1;
        ...
        this.tail3.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed - 8.0f * pi4)) * (float)Math.PI * 0.1f * f1;
        ...
        this.tail4.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed - 9.0f * pi4)) * (float)Math.PI * 0.1f * f1;
        this.jaw.rotateAngleX = e.getAttacking() != 0 ? -1.0f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.45f)) * (float)Math.PI * 0.18f : -1.1f;
