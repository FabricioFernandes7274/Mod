...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.9f * this.wingspeed)) * (float)Math.PI * 0.25f;
        this.lfwing.rotateAngleZ = -0.698f - newangle;
        this.rfwing.rotateAngleZ = 0.698f + newangle;
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.9f * this.wingspeed)) * (float)Math.PI * 0.35f;
        this.lrwing.rotateAngleZ = -0.349f + newangle;
        this.rrwing.rotateAngleZ = 0.349f - newangle;
        if (b.getAttacking() == 0) {
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.051f * this.wingspeed)) * (float)Math.PI * 0.013f;
            a1 = -0.2f;
        } else {
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.51f * this.wingspeed)) * (float)Math.PI * 0.25f;
            a1 = -0.698f;
        }
