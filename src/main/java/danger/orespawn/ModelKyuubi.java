...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        float newangle = 0.0f;
        newangle = (double)f1 > 0.1 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.1f * this.wingspeed)) * (float)Math.PI * 0.2f * f1 : 0.0f;
        ...
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.1f * this.wingspeed)) * (float)Math.PI * 0.08f * f1;
        this.rtArmUpper.rotateAngleX = newangle += net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed)) * (float)Math.PI * 0.01f;
        ...
        this.lfHorn1.rotateAngleY = this.headFire.rotateAngleY + 0.244f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed)) * (float)Math.PI * 0.1f;
        ...
        this.lfHorn2.rotateAngleY = this.headFire.rotateAngleY + 0.244f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed - pi4)) * (float)Math.PI * 0.1f;
        ...
        this.lfHorn3.rotateAngleY = this.headFire.rotateAngleY + 0.244f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed - 2.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.lfHorn4.rotateAngleY = this.headFire.rotateAngleY + 0.244f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed - 3.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.lfHorn5.rotateAngleY = this.headFire.rotateAngleY + 0.244f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed - 4.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.rtHorn1.rotateAngleY = this.headFire.rotateAngleY + -0.244f - net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed)) * (float)Math.PI * 0.1f;
        ...
        this.rtHorn2.rotateAngleY = this.headFire.rotateAngleY + -0.244f - net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed - pi4)) * (float)Math.PI * 0.1f;
        ...
        this.rtHorn3.rotateAngleY = this.headFire.rotateAngleY + -0.244f - net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed - 2.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.rtHorn4.rotateAngleY = this.headFire.rotateAngleY + -0.244f - net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed - 3.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.rtHorn5.rotateAngleY = this.headFire.rotateAngleY + -0.244f - net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed - 4.0f * pi4)) * (float)Math.PI * 0.1f;
        this.tail1.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.9f * this.wingspeed)) * (float)Math.PI * 0.2f;
        this.tail2.rotationPointX = this.tail1.rotationPointX - (float)Math.sin(this.tail1.rotateAngleY) * 3.0f;
        this.tail2.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.9f * this.wingspeed - pi4)) * (float)Math.PI * 0.2f;
        this.tail3.rotationPointX = this.tail2.rotationPointX - (float)Math.sin(this.tail2.rotateAngleY) * 4.0f;
        this.tail3.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.9f * this.wingspeed - 2.0f * pi4)) * (float)Math.PI * 0.2f;
        this.tail4.rotationPointX = this.tail3.rotationPointX - (float)Math.sin(this.tail3.rotateAngleY) * 3.5f;
        this.tail4.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.9f * this.wingspeed - 3.0f * pi4)) * (float)Math.PI * 0.2f;
        this.tail5.rotationPointX = this.tail4.rotationPointX - (float)Math.sin(this.tail4.rotateAngleY) * 5.0f;
        this.tail5.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.9f * this.wingspeed - 4.0f * pi4)) * (float)Math.PI * 0.2f;
        this.tail6.rotationPointX = this.tail5.rotationPointX - (float)Math.sin(this.tail5.rotateAngleY) * 4.0f;
        this.tail6.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.9f * this.wingspeed - 5.0f * pi4)) * (float)Math.PI * 0.2f;
        this.tail7.rotationPointX = this.tail6.rotationPointX - (float)Math.sin(this.tail6.rotateAngleY) * 3.0f;
        this.tail7.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.9f * this.wingspeed - 6.0f * pi4)) * (float)Math.PI * 0.2f;
        this.tail8.rotationPointX = this.tail7.rotationPointX - (float)Math.sin(this.tail7.rotateAngleY) * 2.0f;
        this.tail8.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.9f * this.wingspeed - 7.0f * pi4)) * (float)Math.PI * 0.2f;
        this.tail9.rotationPointX = this.tail8.rotationPointX - (float)Math.sin(this.tail8.rotateAngleY) * 1.0f;
        this.tail9.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.9f * this.wingspeed - 8.0f * pi4)) * (float)Math.PI * 0.2f;
        this.tail1.rotateAngleX = -0.26f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed)) * (float)Math.PI * 0.1f;
        ...
        this.tail2.rotateAngleX = -0.78f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed - pi4)) * (float)Math.PI * 0.1f;
        ...
        this.tail3.rotateAngleX = -1.11f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed - 2.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.tail4.rotateAngleX = -0.18f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed - 3.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.tail5.rotateAngleX = 0.22f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed - 4.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.tail6.rotateAngleX = 0.63f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed - 5.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.tail7.rotateAngleX = 0.89f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed - 6.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.tail8.rotateAngleX = 1.52f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed - 7.0f * pi4)) * (float)Math.PI * 0.1f;
        ...
        this.tail9.rotateAngleX = 2.0f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed - 8.0f * pi4)) * (float)Math.PI * 0.1f;
        GL11.glPushMatrix();
