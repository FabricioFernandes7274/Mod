...
extends EntityTameable {
    ...
    public void updateAITasks() {
        ...
        if (this.kill_count > 25 && this.day_count > 10) {
            ...
            ent = ThePrinceTeen.spawnCreature(this.world, "The Young Adult Prince", this.posX, this.posY, this.posZ);
            if (ent != null) {
        ...
        if (this.world.isRemote) {
            ...
            if (this.getActivity() != 0) {
                ...
                if (this.getPassengers() != null) {
                    ...
                    this.motionY *= 0.94;
                    this.motionZ *= 0.985;
                    if (!this.world.isRemote && (list = this.world.getEntitiesWithinAABBExcludingEntity((Entity)this, this.boundingBox.expand(3.25, 4.0, 3.25))) != null && !list.isEmpty()) {
    ...
    public boolean interact(net.minecraft.entity.player.EntityPlayer par1net.minecraft.entity.player.EntityPlayer) {
        ...
        if (var2 != null && var2.getItem() == Item.getItemFromBlock((Block)Blocks.DIAMOND_BLOCK) && par1net.minecraft.entity.player.EntityPlayer.getDistanceSq((Entity)this) < 25.0) {
            if (!this.world.isRemote) {
                this.setTamed(true);
        ...
        if (this.isTamed()) {
            ...
            if (var2 != null && par1net.minecraft.entity.player.EntityPlayer.getDistanceSq((Entity)this) < 25.0 && var2.getItem() instanceof ItemFood) {
                if (!this.world.isRemote) {
            ...
            if (var2 != null && var2.getItem() == Item.getItemFromBlock((Block)Blocks.ICE) && par1net.minecraft.entity.player.EntityPlayer.getDistanceSq((Entity)this) < 25.0) {
                if (!this.world.isRemote) {
                    this.playTameEffect(true);
            ...
            if (var2 != null && var2.getItem() == Items.FLINT_AND_STEEL && par1net.minecraft.entity.player.EntityPlayer.getDistanceSq((Entity)this) < 25.0) {
                if (!this.world.isRemote) {
                    this.playTameEffect(true);
                    this.world.setEntityState((Entity)this, (byte)6);
                    this.setThePrinceTeenFire(1);
            ...
            if (var2 != null && var2.getItem() == Items.DIAMOND && par1net.minecraft.entity.player.EntityPlayer.getDistanceSq((Entity)this) < 25.0 && !this.world.isRemote) {
                Entity ent = null;
                ThePrince d = null;
                ent = ThePrinceTeen.spawnCreature(this.world, "The Prince", this.posX, this.posY, this.posZ);
                if (ent != null) {
                    d = (ThePrince)ent;
                    if (this.isTamed()) {
                        d.setTamed(true);
