...
extends RenderLiving {
    protected ModelGoldFish model = (ModelGoldFish)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "GoldFish.png");

    public RenderGoldFish(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelGoldFish par1ModelBase, float par2, float par3) {
