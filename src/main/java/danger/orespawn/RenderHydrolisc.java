...
extends RenderLiving {
    protected ModelHydrolisc model = (ModelHydrolisc)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "hydrolisc.png");

    public RenderHydrolisc(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelHydrolisc par1ModelBase, float par2, float par3) {
