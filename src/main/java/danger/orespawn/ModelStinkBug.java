...
extends ModelBase {
    ...
    public void render(Entity entity, float ff, float ff1, float ff2, float ff3, float ff4, float ff5) {
        ...
        float newangle = 0.0f;
        this.f1.rotateAngleX = this.f3.rotateAngleX = (this.f3.rotateAngleX = (newangle = net.minecraft.util.math.MathHelper.sin((float)(ff2 * 3.1f * this.wingspeed)) * (float)Math.PI * 0.3f * ff1));
        this.f4.rotateAngleX = this.f6.rotateAngleX = -newangle;
        this.f2.rotateAngleX = this.f6.rotateAngleX;
        this.b9.rotateAngleZ = newangle = net.minecraft.util.math.MathHelper.sin((float)(ff2 * 0.4f * this.wingspeed)) * (float)Math.PI * 0.2f;
        this.b10.rotateAngleZ = -newangle;
        newangle = net.minecraft.util.math.MathHelper.sin((float)(ff2 * 0.2f * this.wingspeed)) * (float)Math.PI * 0.04f;
        this.jaw.rotateAngleX = 0.18f + newangle;
        this.h1.rotateAngleX = 0.52f + net.minecraft.util.math.MathHelper.sin((float)(ff2 * 0.4f * this.wingspeed)) * (float)Math.PI * 0.15f;
        this.h1.rotateAngleY = -0.3f + net.minecraft.util.math.MathHelper.sin((float)(ff2 * 0.43f * this.wingspeed)) * (float)Math.PI * 0.15f;
        this.h2.rotateAngleX = 0.52f + net.minecraft.util.math.MathHelper.sin((float)(ff2 * 0.46f * this.wingspeed)) * (float)Math.PI * 0.15f;
        this.h2.rotateAngleY = 0.3f + net.minecraft.util.math.MathHelper.sin((float)(ff2 * 0.49f * this.wingspeed)) * (float)Math.PI * 0.15f;
        this.t4.rotateAngleX = this.t5.rotateAngleX = (this.tail.rotateAngleX = -0.2f + net.minecraft.util.math.MathHelper.sin((float)(ff2 * 0.1f * this.wingspeed)) * (float)Math.PI * 0.1f);
