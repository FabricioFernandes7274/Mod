...
extends RenderLiving {
    protected ModelCloudShark model = (ModelCloudShark)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "CloudShark.png");

    public RenderCloudShark(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelCloudShark par1ModelBase, float par2, float par3) {
