...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * this.wingspeed * 0.45f)) * (float)Math.PI * 0.12f * f1;
        ...
        newangle = b.getAttacking() == 0 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.051f * this.wingspeed)) * (float)Math.PI * 0.01f : net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.51f * this.wingspeed)) * (float)Math.PI * 0.07f;
