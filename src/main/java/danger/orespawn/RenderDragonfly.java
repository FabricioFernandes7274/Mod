...
extends RenderLiving {
    protected ModelDragonfly model = (ModelDragonfly)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "dragonfly.png");

    public RenderDragonfly(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelDragonfly par1ModelBase, float par2, float par3) {
