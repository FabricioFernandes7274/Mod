...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        float onoff = 0.0f;
        this.lwing1.rotateAngleY = -0.6f + net.minecraft.util.math.MathHelper.cos((float)(f2 * this.wingspeed)) * (float)Math.PI * 0.35f;
        this.rwing1.rotateAngleY = -2.55f - net.minecraft.util.math.MathHelper.cos((float)(f2 * this.wingspeed)) * (float)Math.PI * 0.35f;
        this.lwing2.rotateAngleY = -0.6f + net.minecraft.util.math.MathHelper.cos((float)(f2 * this.wingspeed * 0.85f)) * (float)Math.PI * 0.25f;
        this.rwing2.rotateAngleY = -2.55f - net.minecraft.util.math.MathHelper.cos((float)(f2 * this.wingspeed * 0.85f)) * (float)Math.PI * 0.25f;
        ...
        this.larm.rotateAngleX = -0.2f + net.minecraft.util.math.MathHelper.cos((float)(f2 * this.wingspeed * 0.15f)) * (float)Math.PI * 0.05f;
        this.rarm.rotateAngleX = -0.2f + net.minecraft.util.math.MathHelper.cos((float)(f2 * this.wingspeed * 0.12f)) * (float)Math.PI * 0.05f;
        this.larm.rotateAngleZ = -0.15f + net.minecraft.util.math.MathHelper.cos((float)(f2 * this.wingspeed * 0.1f)) * (float)Math.PI * 0.03f;
        this.rarm.rotateAngleZ = 0.15f + net.minecraft.util.math.MathHelper.cos((float)(f2 * this.wingspeed * 0.11f)) * (float)Math.PI * 0.03f;
