...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        if ((double)f1 > 0.1) {
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed)) * (float)Math.PI * 0.15f * f1;
            newangle2 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 2.6f * this.wingspeed)) * (float)Math.PI * 0.1f * f1;
        } else {
            newangle2 = 0.0f;
            newangle = 0.0f;
        }
        ...
        this.crest.rotationPointZ = this.beak.rotationPointZ = this.neck.rotationPointZ + net.minecraft.util.math.MathHelper.sin((float)this.neck.rotateAngleX) * 7.0f;
        this.head.rotationPointZ = this.beak.rotationPointZ;
        this.crest.rotationPointY = this.beak.rotationPointY = this.neck.rotationPointY + net.minecraft.util.math.MathHelper.cos((float)this.neck.rotateAngleX) * 7.0f;
