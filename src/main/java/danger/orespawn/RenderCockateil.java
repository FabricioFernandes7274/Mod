...
extends RenderLiving {
    protected ModelCockateil model = (ModelCockateil)this.mainModel;
    private float scale = 1.0f;

    public RenderCockateil(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelCockateil par1ModelBase, float par2, float par3) {
