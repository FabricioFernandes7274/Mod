...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        newangle = (double)f1 > 0.1 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.1f * this.wingspeed)) * (float)Math.PI * 0.12f * f1 : 0.0f;
        ...
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f)) * (float)Math.PI * 0.02f;
        ...
        if (!g.isSitting()) {
            this.tail.rotateAngleX = 1.0f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.1f)) * (float)Math.PI * 0.06f;
        }
