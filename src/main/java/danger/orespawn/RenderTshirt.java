...
extends RenderLiving {
    protected ModelTshirt model = (ModelTshirt)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "Tshirttexture.png");

    public RenderTshirt(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelTshirt par1ModelBase, float par2, float par3) {
