...
extends RenderLiving {
    protected ModelButterfly model = (ModelButterfly)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("textures/entity/creeper/creeper_armor.png");

    public RenderButterfly(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelButterfly par1ModelBase, float par2, float par3) {
