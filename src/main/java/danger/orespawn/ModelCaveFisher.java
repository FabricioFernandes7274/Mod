...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        float pi4 = 1.570795f;
        this.LFLeg1.rotateAngleY = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 2.0f * this.wingspeed)) * (float)Math.PI * 0.12f * f1;
        ...
        this.LMLeg1.rotateAngleY = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 2.0f * this.wingspeed - 1.0f * pi4)) * (float)Math.PI * 0.12f * f1;
        ...
        this.LBLeg1.rotateAngleY = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 2.0f * this.wingspeed - 2.0f * pi4)) * (float)Math.PI * 0.12f * f1;
