...
extends RenderLiving {
    protected ModelRobot3 model = (ModelRobot3)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "Robot3.png");

    public RenderRobot3(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelRobot3 par1ModelBase, float par2, float par3) {
