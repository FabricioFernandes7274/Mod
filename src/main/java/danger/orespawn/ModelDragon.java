...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        if ((double)f1 > 0.001) {
            ...
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.25f * this.wingspeed)) * (float)Math.PI * lspeed * 0.6f;
        } else {
            newangle = 0.0f;
        }
        if (e.getActivity() != 0) {
        ...
        newangle = e.getAttacking() != 0 ? (e.getActivity() != 0 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.75f * this.wingspeed)) * (float)Math.PI * 0.28f : -0.45f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.85f * this.wingspeed)) * (float)Math.PI * 0.2f) : (e.getActivity() != 0 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.75f * this.wingspeed)) * (float)Math.PI * 0.28f : -0.85f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.2f * this.wingspeed)) * (float)Math.PI * 0.028f);
        ...
        this.tail1.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * tailspeed * this.wingspeed)) * (float)Math.PI * 0.04f;
        ...
        this.tail2.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * tailspeed * this.wingspeed)) * (float)Math.PI * tailamp * 0.125f;
        ...
        this.neck1.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * tailspeed * this.wingspeed)) * (float)Math.PI * tailamp * 0.25f;
        ...
        this.tail3.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * tailspeed * this.wingspeed)) * (float)Math.PI * tailamp * 0.375f;
        ...
        this.tail4.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * tailspeed * this.wingspeed)) * (float)Math.PI * tailamp * 0.5f;
        ...
        this.tail6.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * tailspeed * this.wingspeed)) * (float)Math.PI * tailamp * 0.625f;
        ...
        this.tail5.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * tailspeed * this.wingspeed)) * (float)Math.PI * tailamp * 0.75f;
        if (e.getActivity() == 1) {
        ...
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.5f * this.wingspeed)) * (float)Math.PI * 0.14f;
