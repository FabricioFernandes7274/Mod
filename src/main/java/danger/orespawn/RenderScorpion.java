...
extends RenderLiving {
    protected ModelScorpion model = (ModelScorpion)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "Scorpion.png");

    public RenderScorpion(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelScorpion par1ModelBase, float par2, float par3) {
