...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        float newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.55f)) * (float)Math.PI * 0.15f;
        newangle = (double)f1 > 0.1 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.3f)) * (float)Math.PI * 0.2f * f1 : net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.08f)) * (float)Math.PI * 0.05f;
        ...
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.03f)) * (float)Math.PI * 0.02f;
        this.jaw.rotateAngleX = 0.087f + newangle;
        newangle = (double)f1 > 0.1 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.4f)) * (float)Math.PI * 0.16f * f1 : net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.05f)) * (float)Math.PI * 0.03f;
