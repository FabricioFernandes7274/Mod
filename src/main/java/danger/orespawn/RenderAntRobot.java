...
extends RenderLiving {
    protected ModelAntRobot model = (ModelAntRobot)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "AntRobottexture.png");

    public RenderAntRobot(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelAntRobot par1ModelBase, float par2, float par3) {
