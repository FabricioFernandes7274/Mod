...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        float newangle = (double)f1 > 0.1 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.3f * this.wingspeed)) * (float)Math.PI * 0.12f * f1 : 0.0f;
        ...
        newangle = net.minecraft.util.math.MathHelper.sin((float)((float)Math.toRadians(f2 * 20.0f * this.wingspeed)));
        float nextangle = net.minecraft.util.math.MathHelper.sin((float)((float)Math.toRadians(f2 * 20.0f * this.wingspeed + 1.5f)));
        r = e.getRenderInfo();
