...
extends EntityMob {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue((double)0.32f);
...
//         this.dataManager.set(20, (Object)((byte)par1));
    ...
    protected void dropFewItems(boolean par1, int par2) {
        ...
        var4 = 2 + this.getEntityWorld().rand.nextInt(10);
        for (i = 0; i < var4; ++i) {
    ...
    public void onUpdate() {
        super.onUpdate();
        this.motionY *= 0.6;
        if (this.isInWater() && this.getEntityWorld().rand.nextInt(4) == 1) {
            this.attackEntityAsMob((Entity)this);
        }
    }

    public boolean attackEntityAsMob(Entity par1Entity) {
        boolean var4 = par1Entity.attackEntityFrom(DamageSource.causeMobDamage((net.minecraft.entity.EntityLivingBase)this), (float)OreSpawnMain.Bee_stats.attack);
        if (this.getEntityWorld().rand.nextInt(3) == 1 && par1Entity != null) {
            ((net.minecraft.entity.EntityLivingBase)par1Entity).addPotionEffect(new PotionEffect(MobEffects.POISON, 50, 0));
        }
        return var4;
    }
    ...
    protected void updateAITasks() {
        ...
        if (this.stuck_count > 50 || this.getEntityWorld().rand.nextInt(300) == 0 || this.currentFlightTarget.getDistanceSquared((int)this.posX, (int)this.posY, (int)this.posZ) < 2.1f) {
            Block bid = Blocks.STONE;
            this.stuck_count = 0;
            while (bid != Blocks.AIR && keep_trying != 0) {
                zdir = this.getEntityWorld().rand.nextInt(9) + 4;
                xdir = this.getEntityWorld().rand.nextInt(9) + 4;
                ...
                this.currentFlightTarget = new net.minecraft.util.math.BlockPos((int)this.posX + xdir, (int)this.posY + this.getEntityWorld().rand.nextInt(6) - 3, (int)this.posZ + zdir);
        ...
        } else if (this.getEntityWorld().rand.nextInt(15) == 0) {
            net.minecraft.entity.EntityLivingBase e = null;
            e = (net.minecraft.entity.EntityLivingBase)this.rt;
            if (e != null && e.isDead()) {
                e = null;
            }
            if (e == null) {
            ...
            if (e != null) {
                this.setAttacking(1);
                this.currentFlightTarget = new net.minecraft.util.math.BlockPos((int)e.posX, (int)e.posY + 1, (int)e.posZ);
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
        ...
        if (e != null && e instanceof net.minecraft.entity.EntityLivingBase && this.currentFlightTarget != null) {
            this.rt = e;
