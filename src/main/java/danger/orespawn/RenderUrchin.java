...
extends RenderLiving {
    ...
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "Urchintexture.png");

    public RenderUrchin(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelUrchin par1ModelBase, float par2, float par3) {
