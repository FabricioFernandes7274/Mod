...
extends RenderLiving {
    protected ModelTriffid model = (ModelTriffid)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "Triffidtexture.png");

    public RenderTriffid(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelTriffid par1ModelBase, float par2, float par3) {
