...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed)) * (float)Math.PI * 0.25f;
        this.Wing1.rotateAngleZ = -2.0f + newangle;
        this.Wing2.rotateAngleZ = 2.0f - newangle;
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.3f * this.wingspeed)) * (float)Math.PI * 0.1f;
        this.Jaw.rotateAngleX = Math.abs(newangle);
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.25f)) * (float)Math.PI * 0.35f;
        ...
        this.Tail1.rotateAngleX = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.71f * this.wingspeed)) * (float)Math.PI * 0.1f;
        this.Tail1.rotateAngleY = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.77f * this.wingspeed)) * (float)Math.PI * 0.1f;
        float dist = 6.0f;
        ...
        this.Tail2.rotateAngleX = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.81f * this.wingspeed)) * (float)Math.PI * 0.15f;
        this.Tail2.rotateAngleY = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.87f * this.wingspeed)) * (float)Math.PI * 0.15f;
        dist = 6.0f;
        ...
        this.Tail3.rotateAngleX = this.Tail4.rotateAngleX = (newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.91f * this.wingspeed)) * (float)Math.PI * 0.2f);
        this.Tail3.rotateAngleY = this.Tail4.rotateAngleY = (newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.97f * this.wingspeed)) * (float)Math.PI * 0.2f);
