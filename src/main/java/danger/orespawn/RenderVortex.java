...
extends RenderLiving {
    protected ModelVortex model = (ModelVortex)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "Vortextexture.png");

    public RenderVortex(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelVortex par1ModelBase, float par2, float par3) {
