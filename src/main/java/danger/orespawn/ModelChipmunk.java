...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        newangle = (double)f1 > 0.1 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 2.3f * this.wingspeed)) * (float)Math.PI * 0.25f * f1 : 0.0f;
        ...
        if (!c.isSitting()) {
            this.Tail1.rotateAngleX = 0.306f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.25f)) * (float)Math.PI * 0.06f;
