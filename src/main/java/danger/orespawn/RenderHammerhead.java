...
extends RenderLiving {
    protected ModelHammerhead model = (ModelHammerhead)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "Hammerheadtexture.png");

    public RenderHammerhead(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelHammerhead par1ModelBase, float par2, float par3) {
