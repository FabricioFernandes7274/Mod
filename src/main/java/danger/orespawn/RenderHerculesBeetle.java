...
extends RenderLiving {
    protected ModelHerculesBeetle model = (ModelHerculesBeetle)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "Beetletexture.png");

    public RenderHerculesBeetle(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelHerculesBeetle par1ModelBase, float par2, float par3) {
