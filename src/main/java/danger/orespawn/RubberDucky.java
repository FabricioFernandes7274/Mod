...
extends EntityTameable {
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
        ...
        this.setSitting(false);
        if (!this.world.isRemote && w != null && w instanceof net.minecraft.entity.player.EntityPlayer && (this.isDead() || this.getHealth() <= 0.0f) && this.died == 0) {
            this.died = 1;
            ++this.killcount;
    ...
    public boolean interact(net.minecraft.entity.player.EntityPlayer par1net.minecraft.entity.player.EntityPlayer) {
        ...
        if (var2 != null && var2.getItem() == Items.FISH && par1net.minecraft.entity.player.EntityPlayer.getDistanceSq((Entity)this) < 16.0) {
            if (!this.isTamed()) {
        ...
        if (this.isTamed() && this.getGameProfile((net.minecraft.entity.EntityLivingBase)par1net.minecraft.entity.player.EntityPlayer) && par1net.minecraft.entity.player.EntityPlayer.getDistanceSq((Entity)this) < 16.0) {
    ...
    private net.minecraft.entity.EntityLivingBase findSomethingToAttack() {
        ...
        List var5 = this.world.getEntitiesWithinAABB(net.minecraft.entity.EntityLivingBase.class, this.boundingBox.expand(8.0, 4.0, 8.0));
