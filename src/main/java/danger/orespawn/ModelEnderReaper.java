...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        if (e.isScreaming()) {
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.9f * this.wingspeed)) * (float)Math.PI * 0.25f;
            ...
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 2.7f * this.wingspeed)) * (float)Math.PI * 0.3f;
        } else {
            this.larm1.rotateAngleX = -2.436f;
            this.larm1.rotateAngleY = 1.0f;
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.7f * this.wingspeed)) * (float)Math.PI * 0.06f;
        }
