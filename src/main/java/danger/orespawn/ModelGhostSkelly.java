...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        r = e.getRenderInfo();
        this.lsleeve.rotateAngleZ = this.lchains.rotateAngleZ = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.2f)) * (float)Math.PI * 0.05f;
        this.larm.rotateAngleZ = this.lchains.rotateAngleZ;
        this.rsleeve.rotateAngleZ = this.rchains.rotateAngleZ = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.22f)) * (float)Math.PI * 0.05f;
        this.rarm.rotateAngleZ = this.rchains.rotateAngleZ;
        this.lsleeve.rotateAngleY = this.lchains.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.24f)) * (float)Math.PI * 0.05f;
        this.larm.rotateAngleY = this.lchains.rotateAngleY;
        this.rsleeve.rotateAngleY = this.rchains.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.26f)) * (float)Math.PI * 0.05f;
        this.rarm.rotateAngleY = this.rchains.rotateAngleY;
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.05f)) * (float)Math.PI * 2.0f;
