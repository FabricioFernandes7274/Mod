...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        float newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.25f)) * (float)Math.PI * 0.08f;
        this.neck1.rotateAngleX = newangle -= 0.698f;
        this.neck1.rotateAngleY = newangle2 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.15f)) * (float)Math.PI * 0.07f;
        ...
        this.head1.rotateAngleX = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.35f)) * (float)Math.PI * 0.15f;
        this.head1.rotateAngleY = newangle2 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.45f)) * (float)Math.PI * 0.05f;
        ...
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.57f)) * (float)Math.PI * 0.35f;
        ...
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.63f)) * (float)Math.PI * 0.15f;
        this.tailtip.rotateAngleX = newangle + 0.35f;
        this.tailtip.rotateAngleY = newangle = net.minecraft.util.math.MathHelper.cos((float)((float)((double)(f2 * 0.63f) + 1.57075))) * (float)Math.PI * 0.15f;
