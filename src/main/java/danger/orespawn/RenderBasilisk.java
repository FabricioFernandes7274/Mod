...
extends RenderLiving {
    protected ModelBasilisk model = (ModelBasilisk)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "basilisk.png");

    public RenderBasilisk(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelBasilisk par1ModelBase, float par2, float par3) {
