...
extends RenderLiving {
    protected ModelRotator model = (ModelRotator)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "Rotatortexture.png");

    public RenderRotator(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelRotator par1ModelBase, float par2, float par3) {
