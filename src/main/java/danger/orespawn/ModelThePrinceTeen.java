...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        r = c.getRenderInfo();
        newangle = (double)f1 > 0.1 && current_activity == 0 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed)) * (float)Math.PI * 0.2f * f1 : net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.3f * this.wingspeed)) * (float)Math.PI * 0.04f;
        if (current_activity == 1) {
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.4f * this.wingspeed)) * (float)Math.PI * 0.4f;
        }
        if (c.getAttacking() != 0) {
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.7f * this.wingspeed)) * (float)Math.PI * 0.4f;
        }
        ...
        if ((double)f1 > 0.1) {
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.55f * this.wingspeed)) * (float)Math.PI * 0.25f * f1;
            newangle2 = net.minecraft.util.math.MathHelper.cos((float)((float)((double)(f2 * 0.55f * this.wingspeed) + 1.5707963267948966))) * (float)Math.PI * 0.25f * f1;
            rnewangle = newangle;
        ...
        if (c.getAttacking() != 0) {
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * this.wingspeed)) * (float)Math.PI * 0.25f;
            newangle2 = net.minecraft.util.math.MathHelper.cos((float)((float)((double)(f2 * this.wingspeed) + 1.5707963267948966))) * (float)Math.PI * 0.25f;
            rnewangle = newangle;
            rnewangle2 = newangle2;
            clawangle = 0.0f;
        }
        ...
        this.tail1.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * tailspeed * this.wingspeed)) * (float)Math.PI * tailamp / 4.0f;
        ...
        float Ljx = 0.0f;
        if (c.getAttacking() != 0) {
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.9f * this.wingspeed)) * (float)Math.PI * 0.1f;
            Ljx = 0.25f + newangle;
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.1f * this.wingspeed)) * (float)Math.PI * 0.1f;
            Rjx = 0.25f + newangle;
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed)) * (float)Math.PI * 0.1f;
            jx = 0.25f + newangle;
        } else {
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.25f * this.wingspeed)) * (float)Math.PI * 0.02f;
            Ljx = 0.1f + newangle;
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.3f * this.wingspeed)) * (float)Math.PI * 0.02f;
            Rjx = 0.1f + newangle;
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.35f * this.wingspeed)) * (float)Math.PI * 0.02f;
            jx = 0.1f + newangle;
        }
