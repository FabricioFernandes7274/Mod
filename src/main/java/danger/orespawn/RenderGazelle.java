...
extends RenderLiving {
    protected ModelGazelle model = (ModelGazelle)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "Gazelletexture.png");

    public RenderGazelle(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelGazelle par1ModelBase, float par2, float par3) {
