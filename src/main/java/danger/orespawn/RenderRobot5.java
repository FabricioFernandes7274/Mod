...
extends RenderLiving {
    protected ModelRobot5 model = (ModelRobot5)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "Robot5texture.png");

    public RenderRobot5(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelRobot5 par1ModelBase, float par2, float par3) {
