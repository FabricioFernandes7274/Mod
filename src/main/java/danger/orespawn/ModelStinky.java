...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        newangle = (double)f1 > 0.1 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 2.3f * this.wingspeed)) * (float)Math.PI * 0.4f * f1 : 0.0f;
        ...
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.0f * this.wingspeed)) * (float)Math.PI * 0.2f;
        if (c.isSitting()) {
            newangle = 0.0f;
        }
