...
extends RenderLiving {
    ...
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "Kraken.png");

    public RenderKraken(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelKraken par1ModelBase, float par2, float par3) {
