...
extends RenderLiving {
    protected ModelKyuubi model = (ModelKyuubi)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "Kyuubi.png");

    public RenderKyuubi(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelKyuubi par1ModelBase, float par2, float par3) {
