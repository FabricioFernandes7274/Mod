...
implements IRangedAttackMob {
    ...
    public boolean interact(net.minecraft.entity.player.EntityPlayer par1net.minecraft.entity.player.EntityPlayer) {
        ...
        if (var2 != null && (var2.getItem() == Items.COOKED_BEEF || var2.getItem() == OreSpawnMain.MyPeacock) && par1net.minecraft.entity.player.EntityPlayer.getDistanceSq((Entity)this) < 16.0) {
            if (!this.isTamed()) {
                if (!this.world.isRemote) {
        ...
        if (this.isTamed() && var2 != null && (var2.getItem() == Items.LEATHER || var2.getItem() == OreSpawnMain.MyPeacockFeather) && par1net.minecraft.entity.player.EntityPlayer.getDistanceSq((Entity)this) < 16.0 && this.getGameProfile((net.minecraft.entity.EntityLivingBase)par1net.minecraft.entity.player.EntityPlayer)) {
            if (!this.world.isRemote) {
