...
extends EntityTameable {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue(100.0);
    }
    ...
    public void updateAITasks() {
        ...
        super.updateAITasks();
        if (!this.isSitting() && this.getActivity() == 0 && this.getPassengers() == null && this.world.getDifficulty() != EnumDifficulty.PEACEFUL && this.world.rand.nextInt(10) == 1) {
        ...
        if (this.getActivity() == 0 && this.getPassengers() == null && this.world.getDifficulty() != EnumDifficulty.PEACEFUL && this.isTamed() && OreSpawnMain.FullPowerKingEnable != 0) {
            ++this.growcounter;
            if (this.growcounter > 288000) {
                Entity ent = null;
                TheKing d = null;
                ent = ThePrinceAdult.spawnCreature(this.world, "The King", this.posX, this.posY, this.posZ);
                if (ent != null) {
                    d = (TheKing)ent;
                    d.setFree();
                    this.setDead();
    ...
    public void fly_with_rider() {
        ...
        if (this.world.rand.nextInt(5) == 1 && this.world.getDifficulty() != EnumDifficulty.PEACEFUL) {
            ...
            if (e != null) {
                this.setAttacking(1);
                if (this.getDistanceSq((Entity)e) < (double)((10.0f + e.width / 2.0f) * (10.0f + e.width / 2.0f))) {
                    this.attackEntityAsMob((Entity)e);
                } else if (this.getDistanceSq((Entity)e) < 625.0 && !this.isInWater() && this.getThePrinceAdultFire() != 0) {
    ...
    private net.minecraft.entity.EntityLivingBase findSomethingToAttack() {
        ...
        List var5 = this.world.getEntitiesWithinAABB(net.minecraft.entity.EntityLivingBase.class, this.boundingBox.expand(32.0, 20.0, 32.0));
    ...
    public void onUpdate() {
        ...
        if (this.getActivity() == 0 && this.isTamed() && this.getOwner() != null && !this.isSitting() && this.getDistanceSq((Entity)(e = this.getOwner())) > 900.0) {
            this.setActivity(1);
        }
    }
    ...
    private void fly_without_rider() {
        ...
        if (!toofar && this.flyaway == 0 && this.world.getDifficulty() != EnumDifficulty.PEACEFUL && this.world.rand.nextInt(6) == 1) {
            ...
            if (e != null) {
                if (this.isTamed() && this.getHealth() / (float)this.mygetMaxHealth() < 0.25f) {
                    ...
                    if (this.getDistanceSq((Entity)e) < (double)((10.0f + e.width / 2.0f) * (10.0f + e.width / 2.0f))) {
                        ...
                        do_new = true;
                    } else if (this.getDistanceSq((Entity)e) < 600.0 && !this.isInWater() && this.getThePrinceAdultFire() != 0 && this.world.rand.nextInt(2) == 1) {
                        this.shoot_something(e.posX, e.posY, e.posZ);
                    }
                }
            } else {
            ...
            while (bid != Blocks.AIR && keep_trying != 0) {
                ...
                if (has_owner) {
                    ...
                    if (this.owner_flying == 0) {
                        zdir = this.world.rand.nextInt(16) + 8;
                        xdir = this.world.rand.nextInt(16) + 8;
                    } else {
                        zdir = this.world.rand.nextInt(12);
                        xdir = this.world.rand.nextInt(12);
                    }
                } else {
                    zdir = this.world.rand.nextInt(15) + 20;
                    xdir = this.world.rand.nextInt(15) + 20;
                }
                ...
                if (this.getPassengers() != null) {
                    ...
                    if (this.fireballticker == 0 && (pp.moveStrafing < -0.001f || pp.moveStrafing > 0.001f)) {
                        ...
                        if (this.which_attack == 0) {
                            ...
                            BetterFireball bf = new BetterFireball(this.world, (net.minecraft.entity.EntityLivingBase)this, 0.0, 0.0, 0.0);
                            bf.setBig();
                            bf.setNotMe();
                        ...
                        if (this.which_attack == 1) {
                            cx = this.posX - xzoff * Math.sin(Math.toRadians(this.rotationYaw + 10.0f));
                            cz = this.posZ + xzoff * Math.cos(Math.toRadians(this.rotationYaw + 10.0f));
                            IceBall var2 = new IceBall(this.world, cx, this.posY + (yoff -= (double)((float)this.getHead3Ext() * 0.08f)), cz);
                        ...
                        if (this.which_attack == 2) {
                            ...
                            ThunderBolt lb = new ThunderBolt(this.world, (net.minecraft.entity.EntityLivingBase)pp);
                    ...
                    this.motionY *= 0.94;
                    this.motionZ *= 0.985;
                    if (!this.world.isRemote && (list = this.world.getEntitiesWithinAABBExcludingEntity((Entity)this, this.boundingBox.expand(6.25, 10.0, 6.25))) != null && !list.isEmpty()) {
    ...
    public boolean interact(net.minecraft.entity.player.EntityPlayer par1net.minecraft.entity.player.EntityPlayer) {
        ...
        if (var2 != null && var2.getItem() == Item.getItemFromBlock((Block)Blocks.DIAMOND_BLOCK) && par1net.minecraft.entity.player.EntityPlayer.getDistanceSq((Entity)this) < 36.0) {
            if (!this.world.isRemote) {
        ...
        if (this.isTamed()) {
            ...
            if (var2 == null && par1net.minecraft.entity.player.EntityPlayer.getDistanceSq((Entity)this) < 36.0) {
                if (!this.world.isRemote) {
            ...
            if (var2 != null && var2.getItem() == Items.BEEF && par1net.minecraft.entity.player.EntityPlayer.getDistanceSq((Entity)this) < 36.0) {
                if (this.world.isRemote) {
            ...
            if (var2 != null && par1net.minecraft.entity.player.EntityPlayer.getDistanceSq((Entity)this) < 36.0 && var2.getItem() instanceof ItemFood) {
                if (!this.world.isRemote) {
            ...
            if (var2 != null && var2.getItem() == Item.getItemFromBlock((Block)Blocks.ICE) && par1net.minecraft.entity.player.EntityPlayer.getDistanceSq((Entity)this) < 36.0) {
                if (!this.world.isRemote) {
                    this.playTameEffect(true);
                    ...
                    par1net.minecraft.entity.player.EntityPlayer.addChatComponentMessage((net.minecraft.util.text.ITextComponent)new net.minecraft.util.text.TextComponentString(healthMessage));
                }
                if (!par1net.minecraft.entity.player.EntityPlayer.capabilities.isCreativeMode) {
                    --var2.stackSize;
                    if (var2.stackSize <= 0) {
            ...
            if (var2 != null && var2.getItem() == Items.FLINT_AND_STEEL && par1net.minecraft.entity.player.EntityPlayer.getDistanceSq((Entity)this) < 36.0) {
                if (!this.world.isRemote) {
                    this.playTameEffect(true);
                    this.world.setEntityState((Entity)this, (byte)6);
                    this.setThePrinceAdultFire(1);
            ...
            if (var2 != null && var2.getItem() == Items.DIAMOND && par1net.minecraft.entity.player.EntityPlayer.getDistanceSq((Entity)this) < 36.0 && !this.world.isRemote) {
                Entity ent = null;
                ThePrinceTeen d = null;
                ent = ThePrinceAdult.spawnCreature(this.world, "The Young Prince", this.posX, this.posY, this.posZ);
                if (ent != null) {
                    d = (ThePrinceTeen)ent;
                    if (this.isTamed()) {
                        d.setTamed(true);
            ...
            if (this.isTamed() && var2 != null && var2.getItem() == Items.NAME_TAG && par1net.minecraft.entity.player.EntityPlayer.getDistanceSq((Entity)this) < 36.0 && this.getGameProfile((net.minecraft.entity.EntityLivingBase)par1net.minecraft.entity.player.EntityPlayer)) {
    ...
    private void firecanon(double x, double y, double z) {
        ...
        bf = new BetterFireball(this.world, (net.minecraft.entity.EntityLivingBase)this, x - cx + (double)r1, y + 0.25 - (this.posY + yoff) + (double)r2, z - cz + (double)r3);
