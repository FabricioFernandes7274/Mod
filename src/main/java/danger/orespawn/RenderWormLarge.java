...
extends RenderLiving {
    protected ModelWormLarge model = (ModelWormLarge)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "WormLargetexture.png");

    public RenderWormLarge(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelWormLarge par1ModelBase, float par2, float par3) {
