...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        float newangle = 0.0f;
        this.t11.rotateAngleX = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.55f)) * (float)Math.PI * 0.15f;
        ...
        this.t11.rotateAngleZ = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.35f)) * (float)Math.PI * 0.1f;
        ...
        this.t12.rotateAngleX = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.45f)) * (float)Math.PI * 0.15f;
        this.t12.rotateAngleZ = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.25f)) * (float)Math.PI * 0.1f;
        this.t21.rotateAngleX = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.65f)) * (float)Math.PI * 0.15f;
        d1 = (float)(Math.sin(newangle) * 7.0);
        d2 = (float)(Math.cos(newangle) * 7.0);
        this.t22.rotationPointZ = this.t21.rotationPointZ + d1;
        this.t21.rotateAngleZ = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.45f)) * (float)Math.PI * 0.1f;
        ...
        this.t22.rotateAngleX = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.55f)) * (float)Math.PI * 0.15f;
        this.t22.rotateAngleZ = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.35f)) * (float)Math.PI * 0.1f;
        this.t31.rotateAngleX = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f)) * (float)Math.PI * 0.15f;
        d1 = (float)(Math.sin(newangle) * 7.0);
        d2 = (float)(Math.cos(newangle) * 7.0);
        this.t32.rotationPointZ = this.t31.rotationPointZ + d1;
        this.t31.rotateAngleZ = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.3f)) * (float)Math.PI * 0.1f;
        d3 = (float)(Math.cos(newangle) * (double)d2);
        d4 = (float)(Math.sin(newangle) * (double)d2);
        this.t32.rotationPointX = this.t31.rotationPointX - d4;
        this.t32.rotationPointY = this.t31.rotationPointY + d3;
        this.t32.rotateAngleX = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.4f)) * (float)Math.PI * 0.15f;
        this.t32.rotateAngleZ = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.2f)) * (float)Math.PI * 0.1f;
        this.t41.rotateAngleX = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.57f)) * (float)Math.PI * 0.15f;
        d1 = (float)(Math.sin(newangle) * 7.0);
        d2 = (float)(Math.cos(newangle) * 7.0);
        this.t42.rotationPointZ = this.t41.rotationPointZ + d1;
        this.t41.rotateAngleZ = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.37f)) * (float)Math.PI * 0.1f;
        d3 = (float)(Math.cos(newangle) * (double)d2);
        d4 = (float)(Math.sin(newangle) * (double)d2);
        this.t42.rotationPointX = this.t41.rotationPointX - d4;
        this.t42.rotationPointY = this.t41.rotationPointY + d3;
        this.t42.rotateAngleX = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.48f)) * (float)Math.PI * 0.15f;
        this.t42.rotateAngleZ = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.29f)) * (float)Math.PI * 0.1f;
        this.body.render(f5);
        this.t11.render(f5);
        this.t12.render(f5);
        this.t21.render(f5);
