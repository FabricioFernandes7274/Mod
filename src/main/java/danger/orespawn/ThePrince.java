...
extends EntityTameable {
    ...
    public boolean interact(net.minecraft.entity.player.EntityPlayer par1net.minecraft.entity.player.EntityPlayer) {
        ...
        if (var2 != null && var2.getItem() == Item.getItemFromBlock((Block)Blocks.DIAMOND_BLOCK) && par1net.minecraft.entity.player.EntityPlayer.getDistanceSq((Entity)this) < 16.0) {
        ...
        if (this.isTamed() && var2 != null && this.getGameProfile((net.minecraft.entity.EntityLivingBase)par1net.minecraft.entity.player.EntityPlayer) && par1net.minecraft.entity.player.EntityPlayer.getDistanceSq((Entity)this) < 16.0 && var2.getItem() instanceof ItemFood) {
            if (!this.world.isRemote) {
        ...
        if (var2 != null && var2.getItem() == Items.DIAMOND && par1net.minecraft.entity.player.EntityPlayer.getDistanceSq((Entity)this) < 16.0 && this.getGameProfile((net.minecraft.entity.EntityLivingBase)par1net.minecraft.entity.player.EntityPlayer) && !this.world.isRemote && this.ok_to_grow != 0) {
            Entity ent = null;
            ThePrinceTeen d = null;
            ent = ThePrince.spawnCreature(this.world, "The Young Prince", this.posX, this.posY, this.posZ);
            if (ent != null) {
                d = (ThePrinceTeen)ent;
                if (this.isTamed()) {
                    d.setTamed(true);
    ...
    protected float getSoundPitch() {
        return (this.world.rand.nextFloat() - this.world.rand.nextFloat()) * 0.2f + 1.3f;
    }
