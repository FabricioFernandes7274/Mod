...
import net.minecraft.world.World;
    ...
    private net.minecraft.entity.EntityLivingBase findSomethingToAttack() {
        ...
        List var5 = this.world.getEntitiesWithinAABB(net.minecraft.entity.EntityLivingBase.class, this.boundingBox.expand(6.0, 4.0, 6.0));
    ...
    private int findBuddies() {
        List var5 = this.world.getEntitiesWithinAABB(Irukandji.class, this.boundingBox.expand(16.0, 8.0, 16.0));
        return var5.size();
    }
