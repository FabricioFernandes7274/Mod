...
extends EntityLiving {
    ...
    public GodzillaHead(World worldIn) {
        super(worldIn);
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue((double)OreSpawnMain.Godzilla_stats.health);
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
        ...
        List var5 = this.world.getEntitiesWithinAABB(Godzilla.class, this.boundingBox.expand(32.0, 32.0, 32.0));
