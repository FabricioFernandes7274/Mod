...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        r = e.getRenderInfo();
        newangle = e.getActivity() != 0 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.45f * this.wingspeed / pscale)) * (float)Math.PI * 0.24f : -pi4 + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.05f * this.wingspeed / pscale)) * (float)Math.PI * 0.02f;
        ...
        if (e.getAttacking() != 0) {
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.85f * this.wingspeed)) * (float)Math.PI * 0.16f;
            newangle += 0.5f;
        } else {
            ...
            r.rf1 = newangle;
            if (r.ri1 != 0) {
                newangle = net.minecraft.util.math.MathHelper.sin((float)(f2 * 0.85f * this.wingspeed)) * (float)Math.PI * 0.16f;
                newangle += 0.5f;
            } else {
                newangle = pi4 / 4.0f;
            }
        ...
        if (e.getActivity() == 0) {
            ...
            float t2 = 0.0f;
            if ((double)f1 > 0.001) {
                newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.75f * this.wingspeed / pscale));
                t1 = net.minecraft.util.math.MathHelper.sin((float)(f2 * 0.75f * this.wingspeed / pscale));
            } else {
                newangle = 0.0f;
                t1 = 0.0f;
                t2 = 0.0f;
            ...
            this.leftleg3.rotateAngleX = -0.61f + newangle * (float)Math.PI * 0.18f * f1;
            this.llegspike.rotateAngleX = -0.785f + newangle * (float)Math.PI * 0.18f * f1;
            this.leftleg1.rotateAngleX = -0.576f + newangle * (float)Math.PI * 0.18f * f1;
            this.leftleg2.rotateAngleX = 0.977f + newangle * (float)Math.PI * 0.18f * f1;
            ...
            t2 = 0.0f;
            if ((double)f1 > 0.001) {
                newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.75f * this.wingspeed / pscale + pi4 * 4.0f));
                t1 = net.minecraft.util.math.MathHelper.sin((float)(f2 * 0.75f * this.wingspeed / pscale + pi4 * 4.0f));
            } else {
                newangle = 0.0f;
                t1 = 0.0f;
                t2 = 0.0f;
            ...
            this.rightleg3.rotateAngleX = -0.61f + newangle * (float)Math.PI * 0.18f * f1;
            this.llegspike2.rotateAngleX = -0.785f + newangle * (float)Math.PI * 0.18f * f1;
            this.rightleg1.rotateAngleX = -0.576f + newangle * (float)Math.PI * 0.18f * f1;
            this.rightleg2.rotateAngleX = 0.977f + newangle * (float)Math.PI * 0.18f * f1;
            ...
            clawZ = 7.0f;
            clawY = 9.0f;
            newangle = e.getAttacking() != 0 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.85f * this.wingspeed / pscale)) * 0.2f : 0.0f;
        ...
        this.tail1.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * tailspeed * this.wingspeed)) * (float)Math.PI * tailamp / 2.0f;
