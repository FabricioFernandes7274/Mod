...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        if ((double)f1 > 0.001) {
            ...
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.75f * this.wingspeed)) * (float)Math.PI * lspeed * 0.4f;
        ...
        newangle = e.getActivity() != 0 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.55f * this.wingspeed)) * (float)Math.PI * 0.28f : (e.getAttacking() == 0 ? -0.85f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.2f * this.wingspeed)) * (float)Math.PI * 0.028f : -0.65f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.9f * this.wingspeed)) * (float)Math.PI * 0.068f);
        ...
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.15f * this.wingspeed)) * (float)Math.PI * 0.05f;
        ...
        this.tailfin1.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * tailspeed * this.wingspeed - 3.0f * pi4)) * (float)Math.PI * tailamp;
        ...
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed)) * (float)Math.PI * 0.14f;
