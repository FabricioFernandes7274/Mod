...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        float onoff = 0.0f;
        this.wing_left.rotateAngleZ = 1.11f + net.minecraft.util.math.MathHelper.cos((float)(f2 * this.wingspeed)) * (float)Math.PI * 0.35f;
        this.wing_right.rotateAngleZ = -1.11f - net.minecraft.util.math.MathHelper.cos((float)(f2 * this.wingspeed)) * (float)Math.PI * 0.35f;
        this.body.render(f5);
