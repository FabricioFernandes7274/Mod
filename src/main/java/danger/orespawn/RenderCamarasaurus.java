...
extends RenderLiving {
    protected ModelCamarasaurus model = (ModelCamarasaurus)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "camarasaurus.png");

    public RenderCamarasaurus(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelCamarasaurus par1ModelBase, float par2, float par3) {
