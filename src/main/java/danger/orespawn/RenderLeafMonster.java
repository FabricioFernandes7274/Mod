...
extends RenderLiving {
    protected ModelLeafMonster model = (ModelLeafMonster)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "LeafMonstertexture.png");

    public RenderLeafMonster(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelLeafMonster par1ModelBase, float par2, float par3) {
