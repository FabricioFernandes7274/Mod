...
import net.minecraft.world.World;
    ...
    protected void updateAITasks() {
        ...
        super.updateAITasks();
        if (this.owned == 0 && this.getEntityWorld().getDifficulty() != EnumDifficulty.PEACEFUL) {
            if (this.getEntityWorld().rand.nextInt(20) == 0) {
                this.feetFindSomethingToHit();
            }
            if (this.getEntityWorld().rand.nextInt(150) == 0) {
            ...
            if (e != null && this.getEntityWorld().rand.nextInt(15) == 0) {
...
//         this.dataManager.register(20, (Object)i);
    ...
    public void onUpdate() {
        super.onUpdate();
        this.setFire(0);
        if (this.getEntityWorld().getDifficulty() != EnumDifficulty.PEACEFUL && !this.getEntityWorld().isRemote && this.getPassengers() != null && this.getEntityWorld().rand.nextInt(50) == 0) {
            this.feetFindSomethingToHit();
        }
        if (this.getEntityWorld().getDifficulty() != EnumDifficulty.PEACEFUL && !this.getEntityWorld().isRemote && this.getPassengers() != null && this.getEntityWorld().rand.nextInt(9) == 0) {
            net.minecraft.entity.EntityLivingBase e = null;
        ...
        if (this.getEntityWorld().rand.nextInt(18) == 0) {
            this.getEntityWorld().spawnParticle(net.minecraft.util.EnumParticleTypes.FLAME, this.posX + (double)dx, this.posY + 0.5, this.posZ + (double)dz, (double)(dx2 / f + (this.getEntityWorld().rand.nextFloat() - this.getEntityWorld().rand.nextFloat()) / 20.0f), (double)((this.getEntityWorld().rand.nextFloat() - this.getEntityWorld().rand.nextFloat()) / 10.0f), (double)(dz2 / f + (this.getEntityWorld().rand.nextFloat() - this.getEntityWorld().rand.nextFloat()) / 20.0f));
        }
        if (this.getEntityWorld().rand.nextInt(7) == 0) {
            this.getEntityWorld().spawnParticle(net.minecraft.util.EnumParticleTypes.SMOKE_NORMAL, this.posX + (double)dx, this.posY + 0.5, this.posZ + (double)dz, (double)(dx2 / f + (this.getEntityWorld().rand.nextFloat() - this.getEntityWorld().rand.nextFloat()) / 20.0f), (double)((this.getEntityWorld().rand.nextFloat() - this.getEntityWorld().rand.nextFloat()) / 10.0f), (double)(dz2 / f + (this.getEntityWorld().rand.nextFloat() - this.getEntityWorld().rand.nextFloat()) / 20.0f));
        }
        if (this.getEntityWorld().rand.nextInt(16) == 0) {
            this.getEntityWorld().spawnParticle(net.minecraft.util.EnumParticleTypes.FIREWORKS_SPARK, this.posX + (double)dx, this.posY + 0.5, this.posZ + (double)dz, (double)(dx2 / f + (this.getEntityWorld().rand.nextFloat() - this.getEntityWorld().rand.nextFloat()) / 20.0f), (double)((this.getEntityWorld().rand.nextFloat() - this.getEntityWorld().rand.nextFloat()) / 5.0f), (double)(dz2 / f + (this.getEntityWorld().rand.nextFloat() - this.getEntityWorld().rand.nextFloat()) / 20.0f));
        }
    ...
    public void onLivingUpdate() {
        ...
        if (this.getPassengers() != null && this.playing == 0 && this.getEntityWorld().rand.nextInt(80) == 1) {
            this.getEntityWorld().playSound(null, this.posX, this.posY, this.posZ, net.minecraft.init.SoundEvents.ENTITY_GENERIC_EXPLODE, net.minecraft.util.SoundCategory.NEUTRAL, 0.35f, 1.0f);
            this.playing = 125;
        }
        if (this.getEntityWorld().isRemote) {
            if (this.getPassengers() == null) {
    ...
    private net.minecraft.entity.EntityLivingBase findSomethingToAttack(float distmul, boolean dircheck) {
        ...
        List var5 = this.getEntityWorld().getEntitiesWithinAABB(net.minecraft.entity.EntityLivingBase.class, this.getEntityBoundingBox().expand(12.0 * (double)distmul, 12.0, 12.0 * (double)distmul));
        Iterator var2 = var5.iterator();
        Entity var3 = null;
        net.minecraft.entity.EntityLivingBase var4 = null;
        while (var2.hasNext()) {
...
//         this.dataManager.set(20, (Object)par1);
    ...
    protected void dropFewItems(boolean par1, int par2) {
        ItemStack is = null;
        int i = 7 + this.getEntityWorld().rand.nextInt(7);
