...
extends RenderLiving {
    protected ModelCrab model = (ModelCrab)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "RobotCrabtexture.png");

    public RenderCrab(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelCrab par1ModelBase, float par2, float par3) {
