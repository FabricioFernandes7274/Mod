...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        newangle = (double)f1 > 0.1 || e.getAttacking() != 0 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed)) * (float)Math.PI * 0.2f * f1 : 0.0f;
        ...
        newangle = (double)f1 > 0.1 || e.getAttacking() != 0 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.2f * this.wingspeed)) * (float)Math.PI * 0.2f * f1 : net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.2f * this.wingspeed)) * (float)Math.PI * 0.02f;
        ...
        newangle = (double)f1 > 0.1 || e.getAttacking() != 0 ? 0.455f * f1 + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.9f * this.wingspeed)) * (float)Math.PI * 0.25f * f1 : net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.3f * this.wingspeed)) * (float)Math.PI * 0.02f;
        ...
        if (e.getAttacking() != 0) {
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.7f * this.wingspeed)) * (float)Math.PI * 0.17f;
            this.BottomJaw.rotateAngleX = 0.45f + newangle;
        } else {
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.2f * this.wingspeed)) * (float)Math.PI * 0.05f;
