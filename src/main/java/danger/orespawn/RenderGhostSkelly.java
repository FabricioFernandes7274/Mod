...
extends RenderLiving {
    ...
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "GhostSkellytexture.png");

    public RenderGhostSkelly(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelGhostSkelly par1ModelBase, float par2, float par3) {
