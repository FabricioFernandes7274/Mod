...
extends RenderLiving {
    ...
    protected ModelThePrincess model = (ModelThePrincess)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "ThePrincesstexture.png");
    private static final ResourceLocation texture2 = new net.minecraft.util.ResourceLocation("orespawn", "ThePrincesstexture2.png");

    public RenderThePrincess(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelThePrincess par1ModelBase, float par2, float par3) {
