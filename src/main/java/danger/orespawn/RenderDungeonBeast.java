...
extends RenderLiving {
    protected ModelDungeonBeast model = (ModelDungeonBeast)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "Botwtexture.png");

    public RenderDungeonBeast(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelDungeonBeast par1ModelBase, float par2, float par3) {
