        ...
        if ((bid = par1World.getBlock(par2, par3 + 1, par4)) == Blocks.AIR) {
            ...
            if (var7 >= 5 - this.myMaxHeight / 3) {
                if (Height < this.myMaxHeight) {
                    par1World.setBlockState(par2, par3 + 1, par4, OreSpawnMain.MyQuinoaPlant1, this.myMaxHeight << 8, 2);
                    par1World.setBlockState(par2, par3, par4, OreSpawnMain.MyQuinoaPlant2, this.myMaxHeight << 8, 2);
                } else {
                    ...
                    if (bid == OreSpawnMain.MyQuinoaPlant1) {
                        par1World.setBlockState(par2, par3, par4, OreSpawnMain.MyQuinoaPlant3, this.myMaxHeight << 8, 2);
                    } else if (bid == OreSpawnMain.MyQuinoaPlant3) {
                        par1World.setBlockState(par2, par3, par4, OreSpawnMain.MyQuinoaPlant4, this.myMaxHeight << 8, 2);
                    }
                    bid = par1World.getBlockState(new net.minecraft.util.math.BlockPos(par2, par3, par4)).getBlock();
