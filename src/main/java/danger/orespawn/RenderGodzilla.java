...
extends RenderLiving {
    protected ModelGodzilla model = (ModelGodzilla)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "Godzillatexture.png");

    public RenderGodzilla(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelGodzilla par1ModelBase, float par2, float par3) {
