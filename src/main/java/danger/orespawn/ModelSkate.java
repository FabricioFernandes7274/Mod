...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        float newangle = 0.0f;
        newangle = (double)f1 > 0.1 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.2f)) * (float)Math.PI * 0.15f * f1 : net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.4f)) * (float)Math.PI * 0.05f;
