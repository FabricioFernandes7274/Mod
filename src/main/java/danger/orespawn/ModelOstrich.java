...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.25f * this.wingspeed)) * (float)Math.PI * lspeed * 0.4f;
        ...
        this.Tail2.rotateAngleX = this.Tail1.rotateAngleX = -0.594f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.05f)) * (float)Math.PI * 0.06f;
        this.Tail3.rotateAngleX = this.Tail1.rotateAngleX;
        this.Tail3.rotateAngleY = -0.334f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.061f)) * (float)Math.PI * 0.08f;
        this.Tail2.rotateAngleY = 0.334f - net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.072f)) * (float)Math.PI * 0.08f;
        r = o.getRenderInfo();
        if (o.getPassengers() != null) {
        ...
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.0f * this.wingspeed)) * (float)Math.PI * 0.15f;
        nextangle = net.minecraft.util.math.MathHelper.cos((float)((f2 + 0.3f) * 1.0f * this.wingspeed)) * (float)Math.PI * 0.15f;
        if (nextangle > 0.0f && newangle < 0.0f) {
            r.ri1 = 0;
            if (o.world.rand.nextInt(3) == 1) {
                r.ri1 = 1;
            }
        }
        if (r.ri1 == 0) {
