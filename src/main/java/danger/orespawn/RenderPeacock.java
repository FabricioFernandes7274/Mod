...
extends RenderLiving {
    protected ModelPeacock model = (ModelPeacock)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "peacocktexture.png");

    public RenderPeacock(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelPeacock par1ModelBase, float par2, float par3) {
