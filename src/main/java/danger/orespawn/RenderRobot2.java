...
extends RenderLiving {
    protected ModelRobot2 model = (ModelRobot2)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "Robot2.png");

    public RenderRobot2(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelRobot2 par1ModelBase, float par2, float par3) {
