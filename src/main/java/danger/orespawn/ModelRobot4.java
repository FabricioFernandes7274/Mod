...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        newangle = (double)f1 > 0.1 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed)) * (float)Math.PI * 0.15f * f1 : 0.0f;
        ...
        if (e.getAttacking() != 0) {
            newangle = net.minecraft.util.math.MathHelper.cos((float)((float)Math.toRadians(f2 % 360.0f) * this.wingspeed * 6.0f)) * amp;
