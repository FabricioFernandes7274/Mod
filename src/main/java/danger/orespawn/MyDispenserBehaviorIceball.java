...
public class MyDispenserBehaviorIceball extends EntityMob {
...
extends BehaviorProjectileDispense {
    ...
    protected IProjectile getProjectileEntity(World worldIn, IPosition par2IPosition) {
        IceBall entityarrow = new IceBall(worldIn, par2IPosition.getX(), par2IPosition.getY(), par2IPosition.getZ());
        return entityarrow;
    }
}
