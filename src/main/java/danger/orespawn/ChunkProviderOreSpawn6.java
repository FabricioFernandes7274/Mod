...
implements net.minecraft.world.chunk.IChunkProvider {
    ...
    public void replaceBiomeBlocks(int p_147418_1_, int p_147418_2_, Block[] p_147418_3_, byte[] meta, Biome[] biomes) {
        int b0 = 64;
        double d0 = 0.03125;
    ...
    public void populate(net.minecraft.world.chunk.IChunkProvider p_73153_1_, int par2, int par3) {
