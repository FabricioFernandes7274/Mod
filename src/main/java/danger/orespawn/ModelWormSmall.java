...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        this.tail.rotateAngleX = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.55f)) * (float)Math.PI * 0.15f;
        ...
        this.tail.rotateAngleZ = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.35f)) * (float)Math.PI * 0.1f;
        ...
        this.body.rotateAngleX = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.45f)) * (float)Math.PI * 0.15f;
        d1 = (float)(Math.sin(newangle) * 5.0);
        d2 = (float)(Math.cos(newangle) * 5.0);
        this.head.rotationPointZ = this.body.rotationPointZ - d1;
        this.body.rotateAngleZ = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.25f)) * (float)Math.PI * 0.1f;
        ...
        this.head.rotateAngleX = 0.62f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.65f)) * (float)Math.PI * 0.15f;
        this.head.rotateAngleZ = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.3f)) * (float)Math.PI * 0.05f;
        this.head.render(f5);
        this.body.render(f5);
        this.tail.render(f5);
    }
