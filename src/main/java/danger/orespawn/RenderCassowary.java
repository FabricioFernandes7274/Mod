...
extends RenderLiving {
    protected ModelCassowary model = (ModelCassowary)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "Cassowary.png");

    public RenderCassowary(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelCassowary par1ModelBase, float par2, float par3) {
