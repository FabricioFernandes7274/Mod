...
public class ChunkProviderOreSpawn implements IChunkGenerator {
    ...
    public ChunkProviderOreSpawn(World worldIn, long seed, boolean mapFeaturesEnabled) {
        this.world = worldIn;
                    ...
                    for (int l2 = 0; l2 < 8; ++l2) {
                        ...
                        for (int i3 = 0; i3 < 4; ++i3) {
                            ...
                            for (int k3 = 0; k3 < 4; ++k3) {
                                ...
                                if (d15 > 0.0D) {
                                    primer.setBlockState(x, y, z, blockStone);
                                } else if (y < 63) {
                                    primer.setBlockState(x, y, z, blockWater);
                                }
                            }
                            d10 += d12;
                            d11 += d13;
    ...
    public void populate(int x, int z) {
        ...
        if (this.mapFeaturesEnabled) {
            ...
            this.scatteredFeatureGenerator.generateStructure(this.world, this.rand, new ChunkPos(x, z));
        }

        biome.decorate(this.world, this.rand, blockpos);
        
        // MOVIMENTADO PARA AQUI: A geração do Chunker deve ocorrer na fase de Populate na 1.12.2
        // porque altera blocos depois de o mundo já ter gerado a base rochosa.
    ...
    public List<Biome.SpawnListEntry> getPossibleCreatures(EnumCreatureType creatureType, BlockPos pos) {
        ...
        // Mantém a regra do OreSpawn: Monstros clássicos desativados em Utopia
