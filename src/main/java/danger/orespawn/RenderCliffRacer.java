...
extends RenderLiving {
    protected ModelCliffRacer model = (ModelCliffRacer)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "Cliffracertexture.png");

    public RenderCliffRacer(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelCliffRacer par1ModelBase, float par2, float par3) {
