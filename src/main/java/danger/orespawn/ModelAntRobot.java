...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        if (e.getAttacking() == 0) {
            ...
            this.LAntenna.rotateAngleX = net.minecraft.util.math.MathHelper.cos((float)((float)r.gpcounter * 0.35f)) * (float)Math.PI * 0.05f;
            this.LAntenna.rotateAngleZ = 0.54f + net.minecraft.util.math.MathHelper.cos((float)((float)r.gpcounter * 0.25f)) * (float)Math.PI * 0.05f;
            this.RAntenna.rotateAngleX = net.minecraft.util.math.MathHelper.cos((float)((float)r.gpcounter * 0.3f)) * (float)Math.PI * 0.05f;
            this.RAntenna.rotateAngleZ = -0.54f + net.minecraft.util.math.MathHelper.cos((float)((float)r.gpcounter * 0.45f)) * (float)Math.PI * 0.05f;
        } else {
            float newangle = net.minecraft.util.math.MathHelper.cos((float)((float)r.gpcounter * 0.25f)) * (float)Math.PI * 0.22f;
            ...
            this.LAntenna.rotateAngleX = net.minecraft.util.math.MathHelper.cos((float)((float)r.gpcounter * 0.45f)) * (float)Math.PI * 0.1f;
            this.LAntenna.rotateAngleZ = 0.54f + net.minecraft.util.math.MathHelper.cos((float)((float)r.gpcounter * 0.35f)) * (float)Math.PI * 0.1f;
            this.RAntenna.rotateAngleX = net.minecraft.util.math.MathHelper.cos((float)((float)r.gpcounter * 0.4f)) * (float)Math.PI * 0.1f;
            this.RAntenna.rotateAngleZ = -0.54f + net.minecraft.util.math.MathHelper.cos((float)((float)r.gpcounter * 0.55f)) * (float)Math.PI * 0.1f;
        }
        this.Body.render(f5);
