...
extends RenderLiving {
    protected ModelSpiderRobot model = (ModelSpiderRobot)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "SpiderRobottexture.png");

    public RenderSpiderRobot(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelSpiderRobot par1ModelBase, float par2, float par3) {
