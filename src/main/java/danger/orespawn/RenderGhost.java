...
extends RenderLiving {
    protected ModelGhost model = (ModelGhost)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "Ghosttexture.png");

    public RenderGhost(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelGhost par1ModelBase, float par2, float par3) {
