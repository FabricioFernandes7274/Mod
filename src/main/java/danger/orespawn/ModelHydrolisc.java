...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        this.feather2.rotateAngleY = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.25f * this.wingspeed * hf)) * (float)Math.PI * 0.2f * hf;
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.75f * this.wingspeed * hf)) * (float)Math.PI * 0.2f * hf;
