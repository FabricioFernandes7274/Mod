...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        if (newangle < r.rf1) {
            ...
            if (e.world.rand.nextInt(4) == 1) {
                r.ri1 |= 4;
            }
            if (e.world.rand.nextInt(4) == 1) {
                r.ri1 |= 8;
            }
            if (e.world.rand.nextInt(6) == 1) {
                r.ri1 |= 0x10;
            }
            if (e.world.rand.nextInt(6) == 1) {
                r.ri1 |= 0x20;
        ...
        newangle = 0.0f;
        if ((r.ri1 & 1) != 0) {
            newangle = net.minecraft.util.math.MathHelper.sin((float)(f2 * legspeed * this.wingspeed)) * (float)Math.PI * 0.25f;
        }
        ...
        newangle = 0.0f;
        if ((r.ri1 & 4) != 0) {
            newangle = net.minecraft.util.math.MathHelper.sin((float)(f2 * legspeed * this.wingspeed)) * (float)Math.PI * 0.15f;
        }
        ...
        newangle = 0.0f;
        if ((r.ri1 & 0x10) != 0) {
            newangle = net.minecraft.util.math.MathHelper.sin((float)(f2 * legspeed * this.wingspeed)) * (float)Math.PI * 0.1f;
        }
        ...
        newangle = 0.0f;
        if ((r.ri2 & 1) != 0) {
            newangle = net.minecraft.util.math.MathHelper.sin((float)(f2 * mouthspeed * this.wingspeed)) * (float)Math.PI * 0.35f;
            newangle = Math.abs(newangle);
        }
        ...
        this.thorax.rotateAngleX = newangle = net.minecraft.util.math.MathHelper.sin((float)(f2 * 0.1f * this.wingspeed)) * (float)Math.PI * 0.06f;
        this.abdomen.rotationPointY = (float)((double)this.thorax.rotationPointY - Math.sin(newangle) * 14.0);
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.4f * this.wingspeed)) * (float)Math.PI * 0.2f;
