...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        this.lfwing.rotateAngleZ = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed)) * (float)Math.PI * 0.25f;
        this.rfwing.rotateAngleZ = -newangle;
        this.lrwing.rotateAngleZ = newangle + 3.14f;
        this.rrwing.rotateAngleZ = -newangle + 3.14f;
        this.ljaw.rotateAngleX = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.3f * this.wingspeed)) * (float)Math.PI * 0.1f;
