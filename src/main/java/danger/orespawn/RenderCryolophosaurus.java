...
extends RenderLiving {
    protected ModelCryolophosaurus model = (ModelCryolophosaurus)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "cryolophosaurus.png");

    public RenderCryolophosaurus(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelCryolophosaurus par1ModelBase, float par2, float par3) {
