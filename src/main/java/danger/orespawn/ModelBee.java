...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.1f * this.wingspeed)) * (float)Math.PI * 0.3f;
        ...
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.21f * this.wingspeed)) * (float)Math.PI * 0.06f;
        ...
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.27f * this.wingspeed)) * (float)Math.PI * 0.06f;
        ...
        this.LA1.rotateAngleZ = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.31f * this.wingspeed)) * (float)Math.PI * 0.06f;
        this.LA2.rotateAngleZ = newangle;
        this.LA3.rotateAngleZ = newangle;
        this.LeftPom.rotateAngleZ = newangle;
        this.RA1.rotateAngleZ = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.37f * this.wingspeed)) * (float)Math.PI * 0.06f;
        this.RA2.rotateAngleZ = newangle;
        this.RA3.rotateAngleZ = newangle;
        this.RightPom.rotateAngleZ = newangle;
        newangle = b.getAttacking() == 0 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.021f * this.wingspeed)) * (float)Math.PI * 0.023f : net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.11f * this.wingspeed)) * (float)Math.PI * 0.055f;
