...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        float newangle = 0.0f;
        newangle = (double)f1 > 0.1 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed)) * (float)Math.PI * 0.25f * f1 : 0.0f;
        ...
        this.jaw.rotateAngleX = e.getAttacking() != 0 ? 0.52f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.45f)) * (float)Math.PI * 0.18f : 0.1f;
        this.Shape17.rotateAngleX = -0.523f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.1f)) * (float)Math.PI * 0.05f;
        this.Shape11.rotateAngleX = -0.523f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.1f)) * (float)Math.PI * 0.05f;
