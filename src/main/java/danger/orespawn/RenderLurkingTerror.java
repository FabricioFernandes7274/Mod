...
extends RenderLiving {
    protected ModelLurkingTerror model = (ModelLurkingTerror)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "LurkingTerror.png");

    public RenderLurkingTerror(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelLurkingTerror par1ModelBase, float par2, float par3) {
