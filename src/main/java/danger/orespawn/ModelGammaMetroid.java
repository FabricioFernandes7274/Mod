...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        float newangle = 0.0f;
        this.LeftTusk.rotateAngleX = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.81f * this.wingspeed)) * (float)Math.PI * 0.08f;
        this.RightTusk.rotateAngleX = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.87f * this.wingspeed)) * (float)Math.PI * 0.08f;
        this.MiddleTusk.rotateAngleX = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.99f * this.wingspeed)) * (float)Math.PI * 0.08f;
        this.LeftTusk.rotateAngleY = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.11f * this.wingspeed)) * (float)Math.PI * 0.08f;
        this.RightTusk.rotateAngleY = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.17f * this.wingspeed)) * (float)Math.PI * 0.08f;
        this.MiddleTusk.rotateAngleY = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.25f * this.wingspeed)) * (float)Math.PI * 0.08f;
        float nextangle = 0.0f;
        float upangle = 0.0f;
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 2.0f * this.wingspeed)) * (float)Math.PI * 0.12f * f1;
        nextangle = net.minecraft.util.math.MathHelper.cos((float)((f2 + 0.1f) * 2.0f * this.wingspeed)) * (float)Math.PI * 0.12f * f1;
        upangle = 0.0f;
        ...
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.4f * this.wingspeed)) * (float)Math.PI * 0.05f;
        if (e.isSitting()) {
            newangle = 0.0f;
        }
        ...
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.75f * this.wingspeed)) * (float)Math.PI * 0.1f;
