...
extends RenderLiving {
    ...
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "Island.png");

    public RenderIsland(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelIsland par1ModelBase, float par2, float par3) {
