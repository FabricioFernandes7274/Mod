...
extends RenderLiving {
    protected ModelCricket model = (ModelCricket)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "Crickettexture.png");

    public RenderCricket(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelCricket par1ModelBase, float par2, float par3) {
