...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        if ((double)f1 > 0.1) {
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed)) * (float)Math.PI * 0.1f * f1;
            newangle2 = net.minecraft.util.math.MathHelper.cos((float)((float)((double)(f2 * 1.3f * this.wingspeed) + 0.7853981633974483))) * (float)Math.PI * 0.1f * f1;
        } else {
            newangle = 0.0f;
        }
        ...
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.3f * this.wingspeed)) * (float)Math.PI * 0.03f;
        this.back_armour_4.rotateAngleY = 0.349f + newangle;
        this.back_armour_4R.rotateAngleY = -0.349f - newangle;
        newangle = e.getAttacking() != 0 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed)) * (float)Math.PI * 0.13f : 0.0f;
