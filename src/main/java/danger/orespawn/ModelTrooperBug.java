...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        float pi4 = 1.570795f;
        newangle = e.getAttacking() == 0 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.4f * this.wingspeed)) * (float)Math.PI * 0.05f : net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.4f * this.wingspeed)) * (float)Math.PI * 0.1f;
        this.antenna2part2.rotateAngleY = 0.78f + newangle;
        this.antenna1part2.rotateAngleY = -0.78f - newangle;
        newangle = e.getAttacking() == 0 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed)) * (float)Math.PI * 0.05f : net.minecraft.util.math.MathHelper.cos((float)(f2 * 2.5f * this.wingspeed)) * (float)Math.PI * 0.15f;
        ...
        newangle = e.getAttacking() == 0 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.3f * this.wingspeed)) * (float)Math.PI * 0.05f : net.minecraft.util.math.MathHelper.cos((float)(f2 * 2.6f * this.wingspeed)) * (float)Math.PI * 0.2f;
        ...
        newangle = e.getAttacking() == 0 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.1f * this.wingspeed)) * (float)Math.PI * 0.02f : net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.0f * this.wingspeed)) * (float)Math.PI * 0.1f;
        ...
        newangle = e.getAttacking() == 0 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.3f * this.wingspeed)) * (float)Math.PI * 0.015f : net.minecraft.util.math.MathHelper.cos((float)(f2 * 2.6f * this.wingspeed)) * (float)Math.PI * 0.1f;
        ...
        newangle = net.minecraft.util.math.MathHelper.sin((float)(f2 * 2.0f * this.wingspeed)) * (float)Math.PI * 0.12f * f1;
        nextangle = net.minecraft.util.math.MathHelper.sin((float)((f2 + 0.1f) * 2.0f * this.wingspeed)) * (float)Math.PI * 0.12f * f1;
        upangle = 0.0f;
        if (nextangle > newangle) {
            upangle = Math.abs(net.minecraft.util.math.MathHelper.cos((float)(f2 * 2.0f * this.wingspeed)) * (float)Math.PI * 0.12f * f1);
        }
        this.doLeftFrontLeg(newangle, upangle);
        this.doLeftRearLeg(-newangle, upangle);
        newangle = net.minecraft.util.math.MathHelper.sin((float)((float)((double)(f2 * 2.0f * this.wingspeed) + Math.PI))) * (float)Math.PI * 0.12f * f1;
        nextangle = net.minecraft.util.math.MathHelper.sin((float)((float)((double)((f2 + 0.1f) * 2.0f * this.wingspeed) + Math.PI))) * (float)Math.PI * 0.12f * f1;
        upangle = 0.0f;
        if (nextangle > newangle) {
            upangle = Math.abs(net.minecraft.util.math.MathHelper.cos((float)((float)((double)(f2 * 2.0f * this.wingspeed) + Math.PI))) * (float)Math.PI * 0.12f * f1);
        }
