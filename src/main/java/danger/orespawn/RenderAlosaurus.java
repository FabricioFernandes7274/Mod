...
extends RenderLiving {
    protected ModelAlosaurus model = (ModelAlosaurus)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "alosaurus.png");

    public RenderAlosaurus(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelAlosaurus par1ModelBase, float par2, float par3) {
