...
extends RenderLiving {
    protected ModelMantis model = (ModelMantis)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "Mantistexture.png");

    public RenderMantis(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelMantis par1ModelBase, float par2, float par3) {
