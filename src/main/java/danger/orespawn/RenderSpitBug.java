...
extends RenderLiving {
    protected ModelSpitBug model = (ModelSpitBug)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "BlisterBug.png");

    public RenderSpitBug(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelSpitBug par1ModelBase, float par2, float par3) {
