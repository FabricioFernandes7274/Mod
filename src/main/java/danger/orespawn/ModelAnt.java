...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        this.llegbot1.rotateAngleX = this.llegtop1.rotateAngleX = net.minecraft.util.math.MathHelper.cos((float)(f2 * 2.7f)) * (float)Math.PI * 0.45f * f1;
        ...
        this.jawsl.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.4f)) * (float)Math.PI * 0.05f;
