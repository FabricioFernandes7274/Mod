...
extends EntityAnt {
    ...
    public boolean interact(net.minecraft.entity.player.EntityPlayer par1net.minecraft.entity.player.EntityPlayer) {
        ...
        if (par1net.minecraft.entity.player.EntityPlayer.dimension != OreSpawnMain.DimensionID4) {
            net.minecraftforge.fml.common.FMLCommonHandler.instance().getMinecraftServerInstance().getConfigurationManager().transferPlayerToDimension((net.minecraft.entity.player.EntityPlayerMP)par1net.minecraft.entity.player.EntityPlayer, OreSpawnMain.DimensionID4, (Teleporter)new OreSpawnTeleporter(net.minecraftforge.fml.common.FMLCommonHandler.instance().getMinecraftServerInstance().getWorld(OreSpawnMain.DimensionID4), OreSpawnMain.DimensionID4, this.world));
        } else {
