...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        newangle = e.getAttacking() != 0 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed)) * (float)Math.PI * 0.25f : net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.3f * this.wingspeed)) * (float)Math.PI * 0.05f;
        this.tail.rotateAngleY = newangle;
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.02f * this.wingspeed)) * (float)Math.PI * 0.15f;
