...
extends EntityAmbientCreature {
    ...
    protected void updateAITasks() {
        ...
        if (this.getEntityWorld().rand.nextInt(40) == 1 || this.currentFlightTarget.getDistanceSquared((int)this.posX, (int)this.posY, (int)this.posZ) < 2.0f) {
            ...
            if (target != null) {
                this.currentFlightTarget = new net.minecraft.util.math.BlockPos((int)target.posX + this.getEntityWorld().rand.nextInt(3) - this.getEntityWorld().rand.nextInt(3), (int)target.posY + 1, (int)target.posZ + this.getEntityWorld().rand.nextInt(3) - this.getEntityWorld().rand.nextInt(3));
            } else {
                Block bid;
