...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        nextangle = net.minecraft.util.math.MathHelper.cos((float)((f2 + 0.1f) * 2.0f * this.wingspeed - 1.0f * pi4)) * (float)Math.PI * 0.12f * f1;
        upangle = 0.0f;
        if (nextangle > newangle) {
            upangle = 0.47f * f1 - Math.abs(newangle);
        }
        ...
        nextangle = net.minecraft.util.math.MathHelper.cos((float)((f2 + 0.1f) * 2.0f * this.wingspeed - 2.0f * pi4)) * (float)Math.PI * 0.12f * f1;
        upangle = 0.0f;
        if (nextangle > newangle) {
            upangle = 0.47f * f1 - Math.abs(newangle);
        }
        ...
        nextangle = net.minecraft.util.math.MathHelper.cos((float)((f2 + 0.1f) * 2.0f * this.wingspeed - 3.0f * pi4)) * (float)Math.PI * 0.12f * f1;
        upangle = 0.0f;
        if (nextangle > newangle) {
            upangle = 0.47f * f1 - Math.abs(newangle);
        }
