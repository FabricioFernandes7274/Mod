...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        float t2 = 0.0f;
        if ((double)f1 > 0.001) {
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * this.wingspeed / pscale));
            t1 = net.minecraft.util.math.MathHelper.sin((float)(f2 * this.wingspeed / pscale));
        } else {
            newangle = 0.0f;
            t1 = 0.0f;
            t2 = 0.0f;
        ...
        t2 = 0.0f;
        if ((double)f1 > 0.001) {
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * this.wingspeed / pscale + pi4 * 4.0f));
            t1 = net.minecraft.util.math.MathHelper.sin((float)(f2 * this.wingspeed / pscale + pi4 * 4.0f));
        } else {
            newangle = 0.0f;
            t1 = 0.0f;
            t2 = 0.0f;
        ...
        this.tail3.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * tailspeed * this.wingspeed)) * (float)Math.PI * tailamp / 2.0f;
        ...
        this.tail4.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * tailspeed * this.wingspeed)) * (float)Math.PI * tailamp;
        e.setRenderInfo(r);
