...
extends RenderLiving {
    protected ModelRubberDucky model = (ModelRubberDucky)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "RubberDuckytexture.png");
    private static final ResourceLocation texture2 = new net.minecraft.util.ResourceLocation("orespawn", "EvilRubberDuckytexture.png");

    public RenderRubberDucky(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelRubberDucky par1ModelBase, float par2, float par3) {
