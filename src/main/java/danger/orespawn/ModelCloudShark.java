...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.7f * this.wingspeed)) * (float)Math.PI * 0.15f;
        this.leftfin.rotateAngleY = 1.15f + newangle;
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.5f * this.wingspeed)) * (float)Math.PI * 0.15f;
        this.rightfin.rotateAngleY = -0.9f + newangle;
        this.fins.rotateAngleY = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.5f * this.wingspeed)) * (float)Math.PI * 0.25f;
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed)) * (float)Math.PI * 0.1f;
