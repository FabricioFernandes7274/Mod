...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        float newangle = 0.0f;
        float delta = 0.0f;
        newangle = e.getOpenClosed() == 0 ? 0.122522116f : net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.25f * this.wingspeed)) * (float)Math.PI * 0.039f;
        ...
        if (e.getAttacking() != 0) {
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.25f * this.wingspeed)) * (float)Math.PI * 0.5f;
