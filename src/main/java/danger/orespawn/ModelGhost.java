...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        this.LArm.rotateAngleZ = -0.33f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.3f)) * (float)Math.PI * 0.05f;
        this.RArm.rotateAngleZ = 0.33f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.32f)) * (float)Math.PI * 0.05f;
        this.LArm.rotateAngleX = -0.33f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.34f)) * (float)Math.PI * 0.05f;
        this.RArm.rotateAngleX = 0.33f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.36f)) * (float)Math.PI * 0.05f;
        GL11.glPushMatrix();
