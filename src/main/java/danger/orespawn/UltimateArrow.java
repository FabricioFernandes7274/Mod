                ...
                if (var4.entityHit != null) {
                    ...
                    if (OreSpawnMain.ultimate_sword_pvp == 0) {
                        ...
                        if (var4.entityHit instanceof net.minecraft.entity.player.EntityPlayer || var4.entityHit instanceof Girlfriend || var4.entityHit instanceof Boyfriend) {
                            ...
                            this.playSound(net.minecraft.util.SoundEvent.REGISTRY.getObject(new net.minecraft.util.ResourceLocation("random.bowhit", 1.0f, 1.2f / (this.rand.nextFloat() * 0.2f + 0.9f));
                            e.heal(1.0f);
                            this.setDead();
                            return;
                        }
                    ...
                    this.inTile = this.world.getBlockState(new net.minecraft.util.math.BlockPos(this.xTile, this.yTile, this.zTile)).getBlock();
