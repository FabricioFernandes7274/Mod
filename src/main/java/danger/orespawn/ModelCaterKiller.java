...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        newangle = e.getAttacking() != 0 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.7f * this.wingspeed)) * (float)Math.PI * 0.07f : net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed)) * (float)Math.PI * 0.025f;
        this.ljaw.rotateAngleZ = 0.139f + newangle;
        this.rjaw.rotateAngleZ = -0.139f - newangle;
        headoff = e.getAttacking() != 0 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.7f * this.wingspeed)) * 8.0f : net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.3f * this.wingspeed)) * 2.0f;
        ...
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 2.11f * this.wingspeed)) * (float)Math.PI * 0.08f;
        this.ltusk2.rotateAngleY = 0.802f + newangle;
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 2.3f * this.wingspeed)) * (float)Math.PI * 0.08f;
        ...
        for (i = 0; i < 3; ++i) {
            ...
            this.seg1lspike.rotateAngleZ = newangle = net.minecraft.util.math.MathHelper.cos((float)((float)((double)(f2 * 0.91f * this.wingspeed) + 0.39269908169872414 * (double)i))) * (float)Math.PI * 0.08f;
            this.seg1rspike.rotateAngleZ = -newangle;
            newangle = e.getAttacking() != 0 ? net.minecraft.util.math.MathHelper.cos((float)((float)((double)(f2 * 2.91f * this.wingspeed) + 0.39269908169872414 * (double)i))) * (float)Math.PI * 0.15f : net.minecraft.util.math.MathHelper.cos((float)((float)((double)(f2 * 0.35f * this.wingspeed) + 0.39269908169872414 * (double)i))) * (float)Math.PI * 0.04f;
        ...
        for (i = 0; i < 6; ++i) {
            zdist = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.7f * this.wingspeed + zpi)) * 1.5f * f1;
            ...
            this.seg2lspike.rotateAngleZ = newangle = net.minecraft.util.math.MathHelper.cos((float)((float)((double)(f2 * 0.4f * this.wingspeed) - 0.39269908169872414 * (double)i))) * (float)Math.PI * 0.07f;
        ...
        i = 6;
        this.seg3lspike.rotateAngleZ = newangle = net.minecraft.util.math.MathHelper.cos((float)((float)((double)(f2 * 0.4f * this.wingspeed) - 0.39269908169872414 * (double)i))) * (float)Math.PI * 0.07f;
        this.seg3rspike.rotateAngleZ = -newangle;
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.81f * this.wingspeed)) * (float)Math.PI * 0.04f;
        this.seg3lbackspike.rotateAngleX = -0.977f + newangle;
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.87f * this.wingspeed)) * (float)Math.PI * 0.04f;
        this.seg3rbackspike.rotateAngleX = -0.977f + newangle;
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.11f * this.wingspeed)) * (float)Math.PI * 0.04f;
        this.seg3lbackspike.rotateAngleY = 0.28f + newangle;
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed)) * (float)Math.PI * 0.04f;
