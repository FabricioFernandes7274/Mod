...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        this.rfoot2.rotateAngleZ = this.rheel.rotateAngleZ = (newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.4f * this.wingspeed)) * (float)Math.PI * 0.22f * f1);
        ...
        this.bodys1.rotateAngleX = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed)) * (float)Math.PI * 0.07f;
        this.bodys2.rotateAngleX = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed + pi4)) * (float)Math.PI * 0.07f;
        this.bodys3.rotateAngleX = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed + 2.0f * pi4)) * (float)Math.PI * 0.07f;
        this.t1s1.rotateAngleX = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed + 3.0f * pi4)) * (float)Math.PI * 0.07f;
        this.t1s2.rotateAngleX = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed + 4.0f * pi4)) * (float)Math.PI * 0.07f;
        this.t1s3.rotateAngleX = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed + 5.0f * pi4)) * (float)Math.PI * 0.07f;
        this.t2s1.rotateAngleX = -net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed + 6.0f * pi4)) * (float)Math.PI * 0.07f;
        this.t2s2.rotateAngleX = -net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed + 7.0f * pi4)) * (float)Math.PI * 0.07f;
        this.t2s3.rotateAngleX = -net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed + 8.0f * pi4)) * (float)Math.PI * 0.07f;
        this.t3s1.rotateAngleX = -net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed + 9.0f * pi4)) * (float)Math.PI * 0.07f;
        this.t3s2.rotateAngleX = -net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed + 10.0f * pi4)) * (float)Math.PI * 0.07f;
        this.t4s1.rotateAngleX = -net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed + 11.0f * pi4)) * (float)Math.PI * 0.07f;
        this.t5s1.rotateAngleX = -net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed + 12.0f * pi4)) * (float)Math.PI * 0.07f;
        this.t6s1.rotateAngleX = -net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed + 13.0f * pi4)) * (float)Math.PI * 0.07f;
        tailamp = e.getAttacking() == 0 ? f1 : 1.25f;
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.75f * this.wingspeed)) * (float)Math.PI * 0.25f * tailamp;
        ...
        r = e.getRenderInfo();
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 2.0f * this.wingspeed)) * (float)Math.PI * 0.15f;
        nextangle = net.minecraft.util.math.MathHelper.cos((float)((f2 + 0.1f) * 2.0f * this.wingspeed)) * (float)Math.PI * 0.15f;
