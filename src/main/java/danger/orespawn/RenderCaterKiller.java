...
extends RenderLiving {
    protected ModelCaterKiller model = (ModelCaterKiller)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "CaterKillertexture.png");

    public RenderCaterKiller(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelCaterKiller par1ModelBase, float par2, float par3) {
