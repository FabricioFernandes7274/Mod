...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        newangle = (double)f1 > 0.1 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed)) * (float)Math.PI * 0.2f * f1 : 0.0f;
        this.body3.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed)) * (float)Math.PI * 0.4f * f1;
        ...
        this.body4.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed - pi4)) * (float)Math.PI * 0.4f * f1;
        ...
        this.tail1.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed - 2.0f * pi4)) * (float)Math.PI * 0.4f * f1;
        ...
        this.tailtop.rotateAngleY = this.tailmiddle.rotateAngleY = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed - 3.0f * pi4)) * (float)Math.PI * 0.4f * f1;
        ...
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.8f * this.wingspeed)) * (float)Math.PI * 0.1f;
        this.leftear.rotateAngleY = 0.62f + newangle;
        this.rightear.rotateAngleY = -0.62f - newangle;
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.7f * this.wingspeed)) * (float)Math.PI * 0.02f;
        if (e.isSitting()) {
            newangle = 0.0f;
        }
        this.Bodyfin.rotateAngleZ = newangle;
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.6f * this.wingspeed)) * (float)Math.PI * 0.1f;
        if (e.isSitting()) {
            newangle = 0.0f;
        }
        this.neackfin.rotateAngleY = newangle;
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed)) * (float)Math.PI * 0.05f;
        if (e.isSitting()) {
            newangle = 0.0f;
        }
        this.headfin.rotateAngleY = newangle;
        this.jaw.rotateAngleX = e.getAttacking() == 1 ? (newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.2f * this.wingspeed)) * (float)Math.PI * 0.25f) : (e.getAttacking() == 2 ? 0.45f : -0.25f);
