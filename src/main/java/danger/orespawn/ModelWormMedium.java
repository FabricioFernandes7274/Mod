...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        this.tail.rotateAngleX = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.45f)) * (float)Math.PI * 0.1f;
        ...
        this.tail.rotateAngleZ = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.25f)) * (float)Math.PI * 0.08f;
        ...
        this.body.rotateAngleX = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.35f)) * (float)Math.PI * 0.1f;
        ...
        this.body.rotateAngleZ = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.15f)) * (float)Math.PI * 0.07f;
        ...
        this.head2.rotateAngleX = this.head.rotateAngleX = 0.62f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.55f)) * (float)Math.PI * 0.15f;
        this.head2.rotateAngleZ = this.head.rotateAngleZ = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.25f)) * (float)Math.PI * 0.05f;
        ...
        this.tooth1.rotateAngleX = this.tooth1.rotateAngleX - 0.4f - net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.55f)) * (float)Math.PI * 0.15f;
        this.tooth2.rotateAngleX = this.tooth2.rotateAngleX + 0.4f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.55f)) * (float)Math.PI * 0.15f;
        this.tooth3.rotationPointX += 1.0f;
        this.tooth4.rotationPointX -= 1.0f;
        this.tooth3.rotateAngleZ = this.tooth3.rotateAngleZ + 0.4f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.55f)) * (float)Math.PI * 0.15f;
        this.tooth4.rotateAngleZ = this.tooth4.rotateAngleZ - 0.4f - net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.55f)) * (float)Math.PI * 0.15f;
        this.head.render(f5);
        this.body.render(f5);
        this.tail.render(f5);
