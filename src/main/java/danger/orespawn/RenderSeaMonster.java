...
extends RenderLiving {
    protected ModelSeaMonster model = (ModelSeaMonster)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "SeaMonstertexture.png");

    public RenderSeaMonster(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelSeaMonster par1ModelBase, float par2, float par3) {
