...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        if ((double)f1 > 0.1) {
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed)) * (float)Math.PI * 0.25f * f1;
            newangle2 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 2.6f * this.wingspeed)) * (float)Math.PI * 0.025f * f1;
            newangle3 = newangle;
        } else {
            newangle = 0.0f;
            newangle2 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.6f * this.wingspeed)) * (float)Math.PI * 0.005f;
            newangle3 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.3f * this.wingspeed)) * (float)Math.PI * 0.02f;
        }
