...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        this.rff.rotateAngleX = this.lrf.rotateAngleX = (newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 3.7f * this.wingspeed)) * (float)Math.PI * 0.45f * f1);
        this.lff.rotateAngleX = this.rrf.rotateAngleX = -newangle;
        this.teeth.rotateAngleX = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 2.7f * this.wingspeed)) * (float)Math.PI * 0.25f;
        this.tail.rotateAngleX = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.5f * this.wingspeed)) * (float)Math.PI * 0.05f;
        this.head.render(f5);
        this.nose.render(f5);
