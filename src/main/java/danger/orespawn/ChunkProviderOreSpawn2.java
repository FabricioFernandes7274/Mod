...
implements net.minecraft.world.chunk.IChunkProvider {
    ...
    public void populate(net.minecraft.world.chunk.IChunkProvider par1IChunkProvider, int par2, int par3) {
        ...
        if (this.isMapFeaturesEnabled()) {
            this.mineshaftGenerator.generateStructuresInChunk(this.world, this.world.rand, par2, par3);
            this.strongholdGenerator.generateStructuresInChunk(this.world, this.world.rand, par2, par3);
            this.scatteredFeatureGenerator.generateStructuresInChunk(this.world, this.world.rand, par2, par3);
        }
        if (biomegenbase != Biome.desert && biomegenbase != Biome.desertHills && !flag && this.world.rand.nextInt(4) == 0 && TerrainGen.populate((net.minecraft.world.chunk.IChunkProvider)par1IChunkProvider, (World)this.world, (Random)this.world.rand, (int)par2, (int)par3, (boolean)flag, (PopulateChunkEvent.Populate.EventType)PopulateChunkEvent.Populate.EventType.LAKE)) {
            k1 = k + this.world.rand.nextInt(16) + 8;
            l1 = this.world.rand.nextInt(256);
            i2 = l + this.world.rand.nextInt(16) + 8;
            new WorldGenLakes(Blocks.WATER).generateChunk(this.world, this.world.rand, k1, l1, i2);
        }
        if (TerrainGen.populate((net.minecraft.world.chunk.IChunkProvider)par1IChunkProvider, (World)this.world, (Random)this.world.rand, (int)par2, (int)par3, (boolean)flag, (PopulateChunkEvent.Populate.EventType)PopulateChunkEvent.Populate.EventType.LAVA) && !flag && this.world.rand.nextInt(8) == 0) {
            k1 = k + this.world.rand.nextInt(16) + 8;
            l1 = this.world.rand.nextInt(this.world.rand.nextInt(248) + 8);
            i2 = l + this.world.rand.nextInt(16) + 8;
            if (l1 < 63 || this.world.rand.nextInt(10) == 0) {
                new WorldGenLakes(Blocks.LAVA).generateChunk(this.world, this.world.rand, k1, l1, i2);
            }
        }
        boolean doGen = TerrainGen.populate((net.minecraft.world.chunk.IChunkProvider)par1IChunkProvider, (World)this.world, (Random)this.world.rand, (int)par2, (int)par3, (boolean)flag, (PopulateChunkEvent.Populate.EventType)PopulateChunkEvent.Populate.EventType.DUNGEON);
        for (k1 = 0; doGen && k1 < 8; ++k1) {
            l1 = k + this.world.rand.nextInt(16) + 8;
            i2 = this.world.rand.nextInt(256);
            int j2 = l + this.world.rand.nextInt(16) + 8;
            new WorldGenDungeons().generateChunk(this.world, this.world.rand, l1, i2, j2);
        }
        ...
        k += 8;
        l += 8;
        doGen = TerrainGen.populate((net.minecraft.world.chunk.IChunkProvider)par1IChunkProvider, (World)this.world, (Random)this.world.rand, (int)par2, (int)par3, (boolean)flag, (PopulateChunkEvent.Populate.EventType)PopulateChunkEvent.Populate.EventType.ICE);
        for (k1 = 0; doGen && k1 < 16; ++k1) {
            for (l1 = 0; l1 < 16; ++l1) {
                i2 = this.world.getPrecipitationHeight(k + k1, l + l1);
                if (this.world.isBlockFreezable(k1 + k, i2 - 1, l1 + l)) {
                    this.world.setBlockState(new net.minecraft.util.math.BlockPos(new net.minecraft.util.math.BlockPos(k1 + k, i2 - 1, l1 + l)), Blocks.ICE.getDefaultState().getStateFromMeta(2);
                }
                if (!this.world.canSnowAt(k1 + k), i2, l1 + l, true)) continue;
                this.world.setBlockState(new net.minecraft.util.math.BlockPos(new net.minecraft.util.math.BlockPos(k1 + k, i2, l1 + l)), Blocks.SNOW_LAYER.getDefaultState().getStateFromMeta(2);
            }
        }
    ...
    public List getPossibleCreatures(EnumCreatureType par1EnumCreatureType, int par2, int par3, int par4) {
        Biome var5 = this.world.getBiome(new net.minecraft.util.math.BlockPos(par2, 0, par4));
        List l = null;
        if (var5 != null) {
            ...
            if (par1EnumCreatureType == EnumCreatureType.MONSTER) {
                if (this.MyMobList == null) {
                    ...
                    if (OreSpawnMain.AlosaurusEnable != 0) {
                        this.MyMobList.add(new net.minecraft.world.biome.Biome.SpawnListEntry(Alosaurus.class, 8, 1, 2));
                    }
                    if (OreSpawnMain.TRexEnable != 0) {
                        this.MyMobList.add(new net.minecraft.world.biome.Biome.SpawnListEntry(TRex.class, 6, 1, 2));
                    }
                    if (OreSpawnMain.NastysaurusEnable != 0) {
                        this.MyMobList.add(new net.minecraft.world.biome.Biome.SpawnListEntry(Nastysaurus.class, 6, 1, 2));
                    }
                    if (OreSpawnMain.PointysaurusEnable != 0) {
                        this.MyMobList.add(new net.minecraft.world.biome.Biome.SpawnListEntry(Pointysaurus.class, 10, 4, 8));
                    }
                    if (OreSpawnMain.GammaMetroidEnable != 0) {
                        this.MyMobList.add(new net.minecraft.world.biome.Biome.SpawnListEntry(GammaMetroid.class, 35, 4, 7));
                    }
                    if (OreSpawnMain.AlienEnable != 0) {
                        this.MyMobList.add(new net.minecraft.world.biome.Biome.SpawnListEntry(Alien.class, 35, 2, 3));
                    }
                    if (OreSpawnMain.CaveFisherEnable != 0) {
                        this.MyMobList.add(new net.minecraft.world.biome.Biome.SpawnListEntry(CaveFisher.class, 35, 4, 8));
                    }
                    if (OreSpawnMain.CryolophosaurusEnable != 0) {
                        this.MyMobList.add(new net.minecraft.world.biome.Biome.SpawnListEntry(Cryolophosaurus.class, 26, 4, 7));
                    }
                    if (OreSpawnMain.SpyroEnable != 0) {
                        this.MyMobList.add(new net.minecraft.world.biome.Biome.SpawnListEntry(Spyro.class, 5, 1, 2));
                    }
                    for (net.minecraft.world.biome.Biome.SpawnListEntry var3 : l) {
            ...
            if (par1EnumCreatureType == EnumCreatureType.AMBIENT) {
                if (this.MyAmbientList == null) {
                    ...
                    if (OreSpawnMain.VelocityRaptorEnable != 0) {
                        this.MyAmbientList.add(new net.minecraft.world.biome.Biome.SpawnListEntry(VelocityRaptor.class, 1, 2, 4));
                    }
                    if (OreSpawnMain.DragonflyEnable != 0) {
                        this.MyAmbientList.add(new net.minecraft.world.biome.Biome.SpawnListEntry(Dragonfly.class, 2, 1, 3));
                    }
                    if (OreSpawnMain.CamarasaurusEnable != 0) {
                        this.MyAmbientList.add(new net.minecraft.world.biome.Biome.SpawnListEntry(Camarasaurus.class, 1, 2, 4));
                    }
                    if (OreSpawnMain.BaryonyxEnable != 0) {
                        this.MyAmbientList.add(new net.minecraft.world.biome.Biome.SpawnListEntry(Baryonyx.class, 2, 4, 8));
                    }
                    for (net.minecraft.world.biome.Biome.SpawnListEntry var3 : l) {
