...
implements net.minecraft.world.chunk.IChunkProvider {
    ...
    public void populate(net.minecraft.world.chunk.IChunkProvider par1net.minecraft.world.chunk.IChunkProvider, int par2, int par3) {
        ...
        if (biomegenbase != Biome.desert && biomegenbase != Biome.desertHills && !flag && this.rand.nextInt(4) == 0 && TerrainGen.populate((net.minecraft.world.chunk.IChunkProvider)par1net.minecraft.world.chunk.IChunkProvider, (World)this.world, (Random)this.rand, (int)par2, (int)par3, (boolean)flag, (PopulateChunkEvent.Populate.EventType)PopulateChunkEvent.Populate.EventType.LAKE)) {
            k1 = k + this.rand.nextInt(16) + 8;
            l1 = this.rand.nextInt(256);
            i2 = l + this.rand.nextInt(16) + 8;
            new WorldGenLakes(Blocks.WATER).generateChunk(this.world, this.rand, k1, l1, i2);
        }
        if (TerrainGen.populate((net.minecraft.world.chunk.IChunkProvider)par1net.minecraft.world.chunk.IChunkProvider, (World)this.world, (Random)this.rand, (int)par2, (int)par3, (boolean)flag, (PopulateChunkEvent.Populate.EventType)PopulateChunkEvent.Populate.EventType.LAVA) && !flag && this.rand.nextInt(8) == 0) {
            k1 = k + this.rand.nextInt(16) + 8;
        ...
        boolean doGen = TerrainGen.populate((net.minecraft.world.chunk.IChunkProvider)par1net.minecraft.world.chunk.IChunkProvider, (World)this.world, (Random)this.rand, (int)par2, (int)par3, (boolean)flag, (PopulateChunkEvent.Populate.EventType)PopulateChunkEvent.Populate.EventType.DUNGEON);
        ...
        k += 8;
        l += 8;
        doGen = TerrainGen.populate((net.minecraft.world.chunk.IChunkProvider)par1net.minecraft.world.chunk.IChunkProvider, (World)this.world, (Random)this.rand, (int)par2, (int)par3, (boolean)flag, (PopulateChunkEvent.Populate.EventType)PopulateChunkEvent.Populate.EventType.ICE);
    ...
    public List getPossibleCreatures(EnumCreatureType par1EnumCreatureType, int par2, int par3, int par4) {
        Biome var5 = this.world.getBiomeGenForCoords(par2, par4);
        List l = null;
        if (var5 != null) {
