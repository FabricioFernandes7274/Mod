...
extends RenderLiving {
    protected ModelRat model = (ModelRat)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "Rattexture.png");

    public RenderRat(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelRat par1ModelBase, float par2, float par3) {
