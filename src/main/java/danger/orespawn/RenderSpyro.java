...
extends RenderLiving {
    protected ModelSpyro model = (ModelSpyro)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "spyrotexture.png");

    public RenderSpyro(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelSpyro par1ModelBase, float par2, float par3) {
