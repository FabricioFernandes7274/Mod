...
extends RenderLiving {
    protected ModelMosquito model = (ModelMosquito)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "mosquito.png");

    public RenderMosquito(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelMosquito par1ModelBase, float par2, float par3) {
