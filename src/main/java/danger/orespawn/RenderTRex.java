...
extends RenderLiving {
    protected ModelTRex model = (ModelTRex)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "TRextexture.png");

    public RenderTRex(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelTRex par1ModelBase, float par2, float par3) {
