...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        if ((double)f1 > 0.1) {
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f)) * (float)Math.PI * 0.25f * f1;
            newangle2 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.7f)) * (float)Math.PI * 0.25f * f1;
        } else {
            newangle = 0.0f;
            newangle2 = 0.0f;
        }
        ...
        newangle = (double)f1 > 0.1 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.2f)) * (float)Math.PI * 0.25f * f1 : net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.7f)) * (float)Math.PI * 0.05f;
