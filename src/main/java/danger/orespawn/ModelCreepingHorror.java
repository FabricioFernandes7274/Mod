...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        float newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.25f)) * (float)Math.PI * 0.35f * f1;
        ...
        this.pincer1.rotateAngleY = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.48f)) * (float)Math.PI * 0.15f;
        this.pincer1part2.rotateAngleY = newangle;
        this.pincer2.rotateAngleY = -newangle;
        this.pincer2part2.rotateAngleY = -newangle;
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.11f)) * (float)Math.PI * 0.25f;
        ...
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.81f)) * (float)Math.PI * 0.08f;
        this.spike1.rotateAngleX = 0.7f + newangle;
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.87f)) * (float)Math.PI * 0.08f;
        this.spike2.rotateAngleX = 0.7f + newangle;
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.99f)) * (float)Math.PI * 0.08f;
        this.spike3.rotateAngleX = 0.7f + newangle;
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.103f)) * (float)Math.PI * 0.08f;
        this.spike4.rotateAngleX = 0.7f + newangle;
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.107f)) * (float)Math.PI * 0.08f;
        this.spike5.rotateAngleX = 0.7f + newangle;
        this.spike1.rotateAngleY = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.11f)) * (float)Math.PI * 0.08f;
        this.spike2.rotateAngleY = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.17f)) * (float)Math.PI * 0.08f;
        this.spike3.rotateAngleY = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.25f)) * (float)Math.PI * 0.08f;
        this.spike4.rotateAngleY = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.28f)) * (float)Math.PI * 0.08f;
        this.spike5.rotateAngleY = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.31f)) * (float)Math.PI * 0.08f;
        this.spike1.rotateAngleZ = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.41f)) * (float)Math.PI * 0.08f;
        this.spike2.rotateAngleZ = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.47f)) * (float)Math.PI * 0.08f;
        this.spike3.rotateAngleZ = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.55f)) * (float)Math.PI * 0.08f;
        this.spike4.rotateAngleZ = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.58f)) * (float)Math.PI * 0.08f;
        this.spike5.rotateAngleZ = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.61f)) * (float)Math.PI * 0.08f;
        this.body.render(f5);
        this.leg1.render(f5);
