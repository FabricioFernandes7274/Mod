...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        this.hf1.rotateAngleY = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.25f * this.wingspeed * hf)) * (float)Math.PI * 0.1f * hf;
        this.hf2.rotateAngleY = -newangle;
        this.hf3.rotateAngleY = newangle;
        this.hf4.rotateAngleY = -newangle;
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.3f)) * (float)Math.PI * 0.05f;
        ...
        this.lff1.rotateAngleY = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed)) * (float)Math.PI * 0.1f;
        ...
        newangle = c.isSitting() ? 0.0f : net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.4f * this.wingspeed * hf)) * (float)Math.PI * 0.25f * hf;
