...
extends RenderLiving {
    protected ModelStinkBug model = (ModelStinkBug)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "StinkBug.png");

    public RenderStinkBug(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelStinkBug par1ModelBase, float par2, float par3) {
