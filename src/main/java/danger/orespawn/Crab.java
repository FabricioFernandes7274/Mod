...
import net.minecraft.world.World;
    ...
    private net.minecraft.entity.EntityLivingBase findSomethingToAttack() {
        ...
        List var5 = this.world.getEntitiesWithinAABB(net.minecraft.entity.EntityLivingBase.class, this.boundingBox.expand(16.0, 6.0, 16.0));
    ...
    private int findBuddies() {
        List var5 = this.world.getEntitiesWithinAABB(Crab.class, this.boundingBox.expand(24.0, 8.0, 24.0));
        return var5.size();
    }
