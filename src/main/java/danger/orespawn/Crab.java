...
//         this.TargetSorter = new GenericTargetSorter((Entity)this);
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue((double)(0.25D * this.getCrabScale()));
...
//         this.dataManager.set(21, (Object)i);
    ...
    protected void dropFewItems(boolean par1, int par2) {
        Object is = null;
        int var5 = 4 + this.getEntityWorld().rand.nextInt(8);
    ...
    public boolean attackEntityAsMob(Entity par1Entity) {
        boolean var4 = par1Entity.attackEntityFrom(DamageSource.causeMobDamage((net.minecraft.entity.EntityLivingBase)this), (float)OreSpawnMain.Crab_stats.attack * this.getCrabScale());
...
//         this.dataManager.set(20, (Object)((byte)par1));
    ...
    private int findBuddies() {
        List var5 = this.getEntityWorld().getEntitiesWithinAABB(Crab.class, this.getEntityBoundingBox().expand(24.0, 8.0, 24.0));
        return var5.size();
    }
