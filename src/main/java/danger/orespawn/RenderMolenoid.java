...
extends RenderLiving {
    protected ModelMolenoid model = (ModelMolenoid)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "Molenoidtexture.png");

    public RenderMolenoid(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelMolenoid par1ModelBase, float par2, float par3) {
