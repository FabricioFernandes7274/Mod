...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        float newangle = 0.0f;
        newangle = (double)f1 > 0.1 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * this.wingspeed)) * (float)Math.PI * 0.25f * f1 : 0.0f;
        ...
        if (c.getSinging() != 0) {
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 3.0f * this.wingspeed)) * (float)Math.PI * 0.25f;
