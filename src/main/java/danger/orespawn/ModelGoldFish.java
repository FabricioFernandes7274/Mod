...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed)) * (float)Math.PI * 0.15f;
        this.Pectoralfin1.rotateAngleY = 0.4f + newangle;
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.2f * this.wingspeed)) * (float)Math.PI * 0.15f;
        this.Pectoralfin2.rotateAngleY = -0.4f + newangle;
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.1f * this.wingspeed)) * (float)Math.PI * 0.15f;
        ...
        this.Bottomfin1.rotateAngleY = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.7f * this.wingspeed)) * (float)Math.PI * 0.25f;
        this.Bottomfin2.rotateAngleY = -newangle;
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.7f * this.wingspeed)) * (float)Math.PI * 0.1f;
