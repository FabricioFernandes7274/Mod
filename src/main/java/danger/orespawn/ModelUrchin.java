...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        if ((double)f1 > 0.1) {
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.7f * this.wingspeed)) * (float)Math.PI * 0.15f * f1;
            newangle1 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.7f * this.wingspeed)) * (float)Math.PI * 0.15f * f1;
            newangle2 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.65f * this.wingspeed)) * (float)Math.PI * 0.15f * f1;
            newangle3 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.75f * this.wingspeed)) * (float)Math.PI * 0.15f * f1;
            newangle4 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.8f * this.wingspeed)) * (float)Math.PI * 0.15f * f1;
        } else {
            newangle = 0.0f;
            newangle1 = 0.0f;
            newangle2 = 0.0f;
        ...
        if (u.getAttacking() != 0) {
            ...
            newangle1 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.7f * this.wingspeed)) * (float)Math.PI * 0.06f;
            newangle2 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.65f * this.wingspeed)) * (float)Math.PI * 0.06f;
            newangle3 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.75f * this.wingspeed)) * (float)Math.PI * 0.06f;
            newangle4 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.8f * this.wingspeed)) * (float)Math.PI * 0.06f;
            newangle5 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.55f * this.wingspeed)) * (float)Math.PI * 0.06f;
            newangle6 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.45f * this.wingspeed)) * (float)Math.PI * 0.06f;
            newangle7 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.35f * this.wingspeed)) * (float)Math.PI * 0.06f;
            newangle8 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.4f * this.wingspeed)) * (float)Math.PI * 0.06f;
        } else {
            newangle = (float)((double)(f2 * 0.02f) % (Math.PI * 2));
            newangle1 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.07f * this.wingspeed)) * (float)Math.PI * 0.02f;
            newangle2 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.065f * this.wingspeed)) * (float)Math.PI * 0.02f;
            newangle3 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.075f * this.wingspeed)) * (float)Math.PI * 0.02f;
            newangle4 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.08f * this.wingspeed)) * (float)Math.PI * 0.02f;
            newangle5 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.055f * this.wingspeed)) * (float)Math.PI * 0.02f;
            newangle6 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.045f * this.wingspeed)) * (float)Math.PI * 0.02f;
            newangle7 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.035f * this.wingspeed)) * (float)Math.PI * 0.02f;
            newangle8 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.04f * this.wingspeed)) * (float)Math.PI * 0.02f;
        }
