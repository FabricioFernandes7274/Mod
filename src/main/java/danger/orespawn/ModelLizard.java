...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        newangle = (double)f1 > 0.1 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.0f * this.wingspeed)) * (float)Math.PI * 0.25f * f1 : 0.0f;
        ...
        this.BottomJaw.rotateAngleX = e.getAttacking() != 0 ? 0.52f + net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.45f)) * 0.35f : 0.25f;
        ...
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.25f * this.wingspeed)) * (float)Math.PI * 0.05f;
        if (e.getAttacking() != 0) {
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.25f * this.wingspeed)) * (float)Math.PI * 0.35f;
        }
