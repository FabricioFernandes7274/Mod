...
extends Item {
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, net.minecraft.entity.player.EntityPlayer par3net.minecraft.entity.player.EntityPlayer) {
        ...
        par2World.playSoundAtEntity((Entity)par3net.minecraft.entity.player.EntityPlayer, "random.bow", 3.0f, 1.0f);
        if (!par2World.isRemote) {
            par2World.spawnEntity((Entity)new DeadIrukandji(par2World, (net.minecraft.entity.EntityLivingBase)par3net.minecraft.entity.player.EntityPlayer));
        }
