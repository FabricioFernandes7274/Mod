...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.5f * this.wingspeed)) * (float)Math.PI * 0.35f;
        ...
        this.tailfeather1.rotateAngleX = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.3f * this.wingspeed)) * (float)Math.PI * 0.1f;
        this.tailfeather2.rotateAngleX = newangle;
        this.tailfeather3.rotateAngleX = newangle;
        this.feather1.rotateAngleZ = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.1f * this.wingspeed)) * (float)Math.PI * 0.08f;
        this.feather2.rotateAngleZ = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.2f * this.wingspeed)) * (float)Math.PI * 0.08f;
        this.feather3.rotateAngleZ = newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.3f * this.wingspeed)) * (float)Math.PI * 0.08f;
        this.Body.render(f5);
        this.Head.render(f5);
        this.Beak.render(f5);
