...
extends EntityTameable {
    ...
    private boolean isSuitableTarget(net.minecraft.entity.EntityLivingBase par1EntityLiving, boolean par2) {
        ...
        if (par1EntityLiving instanceof net.minecraft.entity.player.EntityPlayer) {
            ...
            return this.name_two == null || !this.name_two.equals(p.getUniqueID().toString());
        }
        return false;
    }
    ...
    public void attackEntityAsFodder(Entity par1Entity, float f) {
        par1Entity.attackEntityFrom(DamageSource.causeMobDamage((net.minecraft.entity.EntityLivingBase)this), f);
    }
