...
extends EntityMob {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue((double)OreSpawnMain.WormLarge_stats.attack);
    }
    ...
    public void onLivingUpdate() {
        ...
        if (worms == null && target != null || OreSpawnMain.PlayNicely != 0) {
            ...
            if ((bid = this.world.getBlock((int)this.posX, (int)this.posY, (int)this.posZ)) == Blocks.TALLGRASS) {
                bid = Blocks.AIR;
            }
            if (bid != Blocks.AIR) {
                this.motionY += 0.25;
            ...
            this.noClip = true;
            bid = this.world.getBlock((int)this.posX, (int)(this.posY + 3.5), (int)this.posZ);
