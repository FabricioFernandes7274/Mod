...
import net.minecraft.world.World;
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue((double)OreSpawnMain.Skate_stats.attack);
    }
...
//         this.dataManager.set(20, (Object)((byte)par1));
    ...
    private int findBuddies() {
        List var5 = this.getEntityWorld().getEntitiesWithinAABB(Skate.class, this.getEntityBoundingBox().expand(16.0, 8.0, 16.0));
        return var5.size();
    }
