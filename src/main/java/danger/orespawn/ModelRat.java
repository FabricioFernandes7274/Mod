...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        float newangle = 0.0f;
        newangle = (double)f1 > 0.1 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.7f * this.wingspeed)) * (float)Math.PI * 0.25f * f1 : 0.0f;
        ...
        newangle = r.getAttacking() != 0 ? net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.5f * this.wingspeed)) * (float)Math.PI * 0.25f : net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.4f * this.wingspeed)) * (float)Math.PI * 0.05f;
