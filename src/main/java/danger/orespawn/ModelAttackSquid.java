...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        if ((double)f1 > 0.1) {
            newangleA = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.25f * this.wingspeed)) * (float)Math.PI * 0.04f * f1;
            newangleB = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.39f * this.wingspeed)) * (float)Math.PI * 0.04f * f1;
            newangle1 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.2f * this.wingspeed)) * (float)Math.PI * 0.4f * f1;
            newangle2 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.1f * this.wingspeed)) * (float)Math.PI * 0.4f * f1;
            newangle3 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.0f * this.wingspeed)) * (float)Math.PI * 0.4f * f1;
            newangle4 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.9f * this.wingspeed)) * (float)Math.PI * 0.4f * f1;
            newangle5 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.8f * this.wingspeed)) * (float)Math.PI * 0.4f * f1;
            newangle6 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.7f * this.wingspeed)) * (float)Math.PI * 0.4f * f1;
            newangle7 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.6f * this.wingspeed)) * (float)Math.PI * 0.4f * f1;
            newangle8 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.5f * this.wingspeed)) * (float)Math.PI * 0.4f * f1;
        } else {
            newangleA = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.25f * this.wingspeed)) * (float)Math.PI * 0.01f;
            newangleB = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.39f * this.wingspeed)) * (float)Math.PI * 0.01f;
            newangle1 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.2f * this.wingspeed)) * (float)Math.PI * 0.1f;
            newangle2 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.1f * this.wingspeed)) * (float)Math.PI * 0.1f;
            newangle3 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.0f * this.wingspeed)) * (float)Math.PI * 0.1f;
            newangle4 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.9f * this.wingspeed)) * (float)Math.PI * 0.1f;
            newangle5 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.8f * this.wingspeed)) * (float)Math.PI * 0.1f;
            newangle6 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.7f * this.wingspeed)) * (float)Math.PI * 0.1f;
            newangle7 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.6f * this.wingspeed)) * (float)Math.PI * 0.1f;
            newangle8 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.5f * this.wingspeed)) * (float)Math.PI * 0.1f;
        }
