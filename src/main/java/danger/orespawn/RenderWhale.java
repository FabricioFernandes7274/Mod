...
extends RenderLiving {
    protected ModelWhale model = (ModelWhale)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "Whaletexture.png");

    public RenderWhale(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelWhale par1ModelBase, float par2, float par3) {
