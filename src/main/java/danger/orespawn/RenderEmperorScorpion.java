...
extends RenderLiving {
    ...
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "emperorscorpion.png");

    public RenderEmperorScorpion(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelEmperorScorpion par1ModelBase, float par2, float par3) {
