...
extends RenderLiving {
    protected ModelSeaViper model = (ModelSeaViper)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "SeaVipertexture.png");

    public RenderSeaViper(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelSeaViper par1ModelBase, float par2, float par3) {
