...
extends RenderLiving {
    protected ModelBee model = (ModelBee)this.mainModel;
    private float scale = 1.0f;
    private static final ResourceLocation texture = new net.minecraft.util.ResourceLocation("orespawn", "Beetexture.png");

    public RenderBee(net.minecraft.client.renderer.entity.RenderManager renderManager, ModelBee par1ModelBase, float par2, float par3) {
