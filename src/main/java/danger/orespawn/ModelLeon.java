...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        if ((double)f1 > 0.1) {
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.8f * this.wingspeed)) * (float)Math.PI * 0.25f * f1;
            newangle2 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.9f * this.wingspeed)) * (float)Math.PI * 0.25f * f1;
        } else {
            newangle = 0.0f;
            newangle2 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.9f * this.wingspeed)) * (float)Math.PI * 0.02f;
            if (e.isSitting()) {
                newangle2 = 0.0f;
            }
        }
        if (e.getActivity() == 0) {
            ...
            newangle2 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 0.6f * this.wingspeed)) * (float)Math.PI * 0.02f;
            ...
            newangle2 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.6f * this.wingspeed * spd)) * (float)Math.PI * 0.06f;
            ...
            if (e.getAttacking() == 0) {
                ...
                this.ffootL.rotateAngleX = (float)Math.PI;
                this.ffootR.rotateAngleX = (float)Math.PI;
                ...
                newangle = -0.7853982f;
                newangle3 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 3.6f * this.wingspeed)) * (float)Math.PI * 0.1f;
                this.fleg_1_L.rotationPointY = this.fabdomen.rotationPointY + 5.0f;
                this.fleg_1_R.rotationPointY = this.fabdomen.rotationPointY + 5.0f;
            ...
            newangle = net.minecraft.util.math.MathHelper.cos((float)(f2 * 1.6f * this.wingspeed * spd)) * (float)Math.PI * 0.26f * amp;
            ...
            if (e.getAttacking() == 0) {
                ...
                newangle2 = net.minecraft.util.math.MathHelper.cos((float)(f2 * 2.6f * this.wingspeed)) * (float)Math.PI * 0.16f;
